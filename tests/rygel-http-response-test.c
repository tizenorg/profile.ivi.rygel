/* rygel-http-response-test.c generated by valac 0.18.0, the Vala compiler
...
static RygelHTTPResponse* rygel_http_response_test_create_response (RygelHTTPResponseTest* self, SoupMessage* msg, GError** error) {
	...
	_tmp0_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (NULL, RYGEL_TYPE_HTTP_SEEK) ? ((RygelHTTPSeek*) NULL) : NULL);
	seek = _tmp0_;
