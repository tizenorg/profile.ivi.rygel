/* rygel-object-creator-test.c generated by valac 0.18.0, the Vala compiler
...
gint rygel_http_object_creator_test_main (gchar** args, int args_length1) {
	gint result = 0;
	RygelHTTPObjectCreatorTest* _tmp0_;
	RygelHTTPObjectCreatorTest* test;
...
static void rygel_http_object_creator_test_test_parse_args (RygelHTTPObjectCreatorTest* self) {
	...
	RygelObjectCreator* _tmp4_;
	RygelObjectCreator* creator;
	RygelObjectCreator* _tmp5_;
	...
	RygelObjectCreator* _tmp13_;
	RygelObjectCreator* _tmp14_;
	...
	RygelObjectCreator* _tmp22_;
	RygelObjectCreator* _tmp23_;
...
static void rygel_http_object_creator_test_test_fetch_container (RygelHTTPObjectCreatorTest* self) {
	...
	_tmp8_ = _tmp7_->code;
	_vala_assert (_tmp6_ == _tmp8_, "action.error_code == no_such_object.code");
	...
	_vala_assert (_tmp10_ == _tmp12_, "action.error_code == no_such_object.code");
	...
	_vala_assert (_tmp32_ == _tmp34_, "action.error_code == no_such_object.code");
