/* rygel-data-source_http-response.c generated by valac 0.20.1.53-91609, the Vala compiler
...
/**
     ...
     */
void rygel_data_source_start (RygelDataSource* self, RygelHTTPSeek* offsets, GError** error) {
#line 68 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
	g_return_if_fail (self != NULL);
#line 68 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
	RYGEL_DATA_SOURCE_GET_INTERFACE (self)->start (self, offsets, error);
#line 92 "rygel-data-source_http-response.c"
}
...
/**
     ...
     */
void rygel_data_source_freeze (RygelDataSource* self) {
#line 77 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
	g_return_if_fail (self != NULL);
#line 77 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
	RYGEL_DATA_SOURCE_GET_INTERFACE (self)->freeze (self);
#line 108 "rygel-data-source_http-response.c"
}
...
/**
     ...
     */
void rygel_data_source_thaw (RygelDataSource* self) {
#line 85 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
	g_return_if_fail (self != NULL);
#line 85 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
	RYGEL_DATA_SOURCE_GET_INTERFACE (self)->thaw (self);
#line 123 "rygel-data-source_http-response.c"
}
...
/**
     ...
     */
void rygel_data_source_stop (RygelDataSource* self) {
#line 92 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
	g_return_if_fail (self != NULL);
#line 92 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
	RYGEL_DATA_SOURCE_GET_INTERFACE (self)->stop (self);
#line 137 "rygel-data-source_http-response.c"
}
...
#line 59 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
...
#line 156 "rygel-data-source_http-response.c"
	} else {
#line 59 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
		data1 = param_values->data[0].v_pointer;
#line 59 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
		data2 = closure->data;
#line 162 "rygel-data-source_http-response.c"
	}
#line 59 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
...
#line 168 "rygel-data-source_http-response.c"
}
...
#line 59 "/home/rmerlino/workspace/tizen/dlna/ivi/3.0/orig/rygel/tests/rygel-data-source_http-response.vala"
		initialized = TRUE;
#line 179 "rygel-data-source_http-response.c"
		/**
...
#line 187 "rygel-data-source_http-response.c"
		/**
...
#line 195 "rygel-data-source_http-response.c"
		/**
...
#line 203 "rygel-data-source_http-response.c"
	}
}
