/* example-server-plugin-vala.c generated by valac 0.18.0, the Vala compiler
...
void module_init (RygelPluginLoader* loader) {
	...
	RygelExampleServerPluginVala* _tmp2_;
	RygelExampleServerPluginVala* plugin;
	RygelPluginLoader* _tmp3_;
	RygelExampleServerPluginVala* _tmp4_;
...
RygelExampleServerPluginVala* rygel_example_server_plugin_vala_construct (GType object_type) {
	...
	RygelExampleRootContainerVala* _tmp0_;
	RygelExampleRootContainerVala* root_container;
