/* example-player-vala.c generated by valac 0.18.0, the Vala compiler
...
RygelExamplePlayerVala* rygel_example_player_vala_get_default (void) {
	...
	RygelExamplePlayerVala* _tmp0_;
	RygelExamplePlayerVala* _tmp2_;
	RygelExamplePlayerVala* _tmp3_;
	_tmp0_ = rygel_example_player_vala_player;
	if (_tmp0_ == NULL) {
		RygelExamplePlayerVala* _tmp1_;
