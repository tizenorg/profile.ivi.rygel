/* rygel-environment-config.c generated by valac 0.18.0, the Vala compiler
...
static gchar* rygel_environment_config_real_get_string (RygelConfiguration* base, const gchar* section, const gchar* key, GError** error) {
	...
	_tmp16_ = _tmp15_;
	_tmp17_ = rygel_environment_config_get_string_variable (self, _tmp16_, &_inner_error_);
	_tmp18_ = _tmp17_;
	_g_free0 (_tmp16_);
	_g_free0 (_tmp14_);
	_g_free0 (_tmp12_);
...
static gint rygel_environment_config_real_get_int (RygelConfiguration* base, const gchar* section, const gchar* key, gint min, gint max, GError** error) {
	...
	_tmp17_ = min;
	_tmp18_ = max;
	_tmp19_ = rygel_environment_config_get_int_variable (self, _tmp16_, _tmp17_, _tmp18_, &_inner_error_);
	_tmp20_ = _tmp19_;
	_g_free0 (_tmp16_);
	_g_free0 (_tmp14_);
	_g_free0 (_tmp12_);
...
static gboolean rygel_environment_config_real_get_bool (RygelConfiguration* base, const gchar* section, const gchar* key, GError** error) {
	...
	_tmp15_ = g_strconcat (_tmp9_, _tmp14_, NULL);
	_tmp16_ = _tmp15_;
	_tmp17_ = rygel_environment_config_get_bool_variable (self, _tmp16_, &_inner_error_);
	_tmp18_ = _tmp17_;
	_g_free0 (_tmp16_);
	_g_free0 (_tmp14_);
	_g_free0 (_tmp12_);
