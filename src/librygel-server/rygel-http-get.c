/* rygel-http-get.c generated by valac 0.18.0, the Vala compiler
...
struct _RygelHttpGetHandleData {
	...
	RygelHTTPItemURI* _tmp35_;
	const gchar* _tmp36_;
	const gchar* _tmp37_;
	GCancellable* _tmp38_;
	GCancellable* _tmp39_;
	RygelHTTPPlaylistHandler* _tmp40_;
	RygelHTTPGetHandler* _tmp41_;
	GCancellable* _tmp42_;
	GCancellable* _tmp43_;
	RygelHTTPIdentityHandler* _tmp44_;
...
static gboolean rygel_http_get_real_handle_co (RygelHttpGetHandleData* _data_) {
	...
	_data_->_tmp35_ = ((RygelHTTPRequest*) _data_->self)->uri;
	_data_->_tmp36_ = rygel_http_item_uri_get_playlist_format (_data_->_tmp35_);
	_data_->_tmp37_ = _data_->_tmp36_;
	if (_data_->_tmp37_ != NULL) {
		_data_->_tmp38_ = rygel_state_machine_get_cancellable ((RygelStateMachine*) _data_->self);
		_data_->_tmp39_ = _data_->_tmp38_;
		_data_->_tmp40_ = rygel_http_playlist_handler_new (_data_->_tmp39_);
		_g_object_unref0 (_data_->self->handler);
		_data_->self->handler = (RygelHTTPGetHandler*) _data_->_tmp40_;
	}
	_data_->_tmp41_ = _data_->self->handler;
	if (_data_->_tmp41_ == NULL) {
		_data_->_tmp42_ = rygel_state_machine_get_cancellable ((RygelStateMachine*) _data_->self);
		_data_->_tmp43_ = _data_->_tmp42_;
		_data_->_tmp44_ = rygel_http_identity_handler_new (_data_->_tmp43_);
		_g_object_unref0 (_data_->self->handler);
		_data_->self->handler = (RygelHTTPGetHandler*) _data_->_tmp44_;
	}
...
static gboolean rygel_http_get_real_find_item_co (RygelHttpGetFindItemData* _data_) {
	...
	if (_data_->_tmp9_ != NULL) {
		...
		rygel_client_hacks_apply (_data_->_tmp10_, G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp11_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _data_->_tmp11_) : NULL);
	}
...
static void __lambda16_ (RygelHTTPGet* self, const gchar* name, const gchar* value) {
	...
	_tmp0_ = name;
	_tmp1_ = value;
	g_debug ("rygel-http-get.vala:184: %s : %s", _tmp0_, _tmp1_);
}
...
static gboolean rygel_http_get_handle_item_request_co (RygelHttpGetHandleItemRequestData* _data_) {
	...
	g_debug ("rygel-http-get.vala:182: Following HTTP headers appended to response:");
...
static void rygel_http_get_ensure_correct_mode (RygelHTTPGet* self, GError** error) {
	...
	if (_tmp7_ == ((0 != _tmp6_label0) ? _tmp6_label0 : (_tmp6_label0 = g_quark_from_static_string ("Streaming")))) {
		switch (0) {
			default:
			{
				...
				gboolean _tmp18_;
				_tmp9_ = self->handler;
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp9_, RYGEL_TYPE_HTTP_TRANSCODE_HANDLER)) {
					_tmp8_ = TRUE;
				} else {
					...
					gboolean _tmp15_;
					gboolean _tmp17_;
					_tmp12_ = ((RygelHTTPRequest*) self)->object;
					_tmp13_ = rygel_media_item_streamable (G_TYPE_CHECK_INSTANCE_TYPE (_tmp12_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _tmp12_) : NULL);
					if (_tmp13_) {
	...
	if (!_tmp34_) {
		...
		GError* _tmp39_;
		_tmp35_ = mode;
		_tmp36_ = ((RygelHTTPRequest*) self)->object;
		_tmp37_ = rygel_media_object_get_id (_tmp36_);
		_tmp38_ = _tmp37_;
		_tmp39_ = g_error_new (RYGEL_HTTP_REQUEST_ERROR, RYGEL_HTTP_REQUEST_ERROR_UNACCEPTABLE, "%s mode not supported for '%s'", _tmp35_, _tmp38_);
