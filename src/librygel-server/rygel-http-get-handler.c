...
#line 36 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	g_return_if_fail (request != NULL);
#line 38 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	_tmp0_ = request;
#line 38 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 38 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	mode = _tmp4_;
#line 39 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	_tmp5_ = mode;
#line 39 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	if (_tmp5_ != NULL) {
#line 441 "rygel-http-get-handler.c"
		RygelHTTPGet* _tmp6_;
		SoupMessage* _tmp7_;
		SoupMessageHeaders* _tmp8_;
		const gchar* _tmp9_;
#line 43 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		_tmp6_ = request;
#line 43 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 456 "rygel-http-get-handler.c"
	}
#line 49 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	_tmp10_ = gupnp_didl_lite_writer_new (NULL);
#line 49 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	didl_writer = _tmp10_;
#line 50 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 52 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		_tmp12_ = request;
#line 52 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 53 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		if (resource != NULL) {
#line 484 "rygel-http-get-handler.c"
			...
			const gchar* _tmp26_;
#line 54 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 55 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
			_tmp21_ = tokens;
#line 55 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
			_tmp21__length1 = tokens_length1;
#line 55 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
			g_assert (_tmp21__length1 == 4);
#line 57 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
			_tmp22_ = request;
#line 57 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 51 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		_g_object_unref0 (resource);
#line 552 "rygel-http-get-handler.c"
	}
	goto __finally24;
	__catch24_g_error:
	{
...
#line 51 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		_inner_error_ = NULL;
#line 61 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 51 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		_g_error_free0 (err);
#line 566 "rygel-http-get-handler.c"
	}
	__finally24:
#line 51 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	if (_inner_error_ != NULL) {
...
#line 51 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
			return;
#line 597 "rygel-http-get-handler.c"
		}
	}
#line 66 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	_tmp28_ = request;
#line 66 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 66 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	if (_tmp31_ != NULL) {
#line 610 "rygel-http-get-handler.c"
		RygelHTTPGet* _tmp32_;
		RygelMediaItem* _tmp33_;
		GeeArrayList* _tmp34_;
		gint _tmp35_;
		gint _tmp36_;
#line 67 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		_tmp32_ = request;
#line 67 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 67 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		_tmp27_ = _tmp36_ > 0;
#line 628 "rygel-http-get-handler.c"
	} else {
#line 66 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		_tmp27_ = FALSE;
...
#line 638 "rygel-http-get-handler.c"
		...
		const gchar* _tmp46_;
#line 68 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		_tmp38_ = request;
#line 68 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 68 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		caption_uri = _tmp42_;
#line 74 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		_tmp43_ = request;
#line 74 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 673 "rygel-http-get-handler.c"
	}
#line 78 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	_tmp47_ = request;
#line 78 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 36 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	_g_free0 (mode);
#line 689 "rygel-http-get-handler.c"
}
...
#line 698 "rygel-http-get-handler.c"
}


static gboolean rygel_http_get_handler_real_knows_size (RygelHTTPGetHandler* self, RygelHTTPGet* request) {
	gboolean result = FALSE;
#line 81 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	g_return_val_if_fail (request != NULL, FALSE);
#line 82 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	result = FALSE;
#line 82 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	return result;
#line 710 "rygel-http-get-handler.c"
}
...
#line 719 "rygel-http-get-handler.c"
}


static RygelHTTPResponse* rygel_http_get_handler_real_render_body (RygelHTTPGetHandler* self, RygelHTTPGet* request, GError** error) {
#line 86 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 86 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	return NULL;
#line 728 "rygel-http-get-handler.c"
}
...
#line 737 "rygel-http-get-handler.c"
}


static GUPnPDIDLLiteResource* rygel_http_get_handler_real_add_resource (RygelHTTPGetHandler* self, GUPnPDIDLLiteItem* didl_item, RygelHTTPGet* request, GError** error) {
#line 89 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 89 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	return NULL;
#line 746 "rygel-http-get-handler.c"
}
...
#line 755 "rygel-http-get-handler.c"
}


RygelHTTPGetHandler* rygel_http_get_handler_construct (GType object_type) {
	RygelHTTPGetHandler * self = NULL;
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	self = (RygelHTTPGetHandler*) g_object_new (object_type, NULL);
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	return self;
#line 765 "rygel-http-get-handler.c"
}
...
GCancellable* rygel_http_get_handler_get_cancellable (RygelHTTPGetHandler* self) {
	GCancellable* result;
	GCancellable* _tmp0_;
#line 33 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 33 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
...
#line 33 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
	return result;
#line 780 "rygel-http-get-handler.c"
}
...
#line 787 "rygel-http-get-handler.c"
}
...
#line 806 "rygel-http-get-handler.c"
}
...
#line 831 "rygel-http-get-handler.c"
}
...
#line 838 "rygel-http-get-handler.c"
}
...
#line 850 "rygel-http-get-handler.c"
}
...
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		break;
#line 880 "rygel-http-get-handler.c"
		default:
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		break;
#line 886 "rygel-http-get-handler.c"
	}
}
...
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		break;
#line 902 "rygel-http-get-handler.c"
		default:
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-http-get-handler.vala"
		break;
#line 908 "rygel-http-get-handler.c"
	}
}
