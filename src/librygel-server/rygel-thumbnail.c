...
RygelThumbnail* rygel_thumbnail_construct (GType object_type, const gchar* mime_type, const gchar* dlna_profile, const gchar* file_extension) {
	...
	const gchar* _tmp2_;
	gchar* _tmp3_;
#line 31 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	g_return_val_if_fail (mime_type != NULL, NULL);
#line 31 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	g_return_val_if_fail (dlna_profile != NULL, NULL);
#line 31 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	g_return_val_if_fail (file_extension != NULL, NULL);
#line 34 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp0_ = mime_type;
#line 34 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp1_ = file_extension;
#line 34 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	self = (RygelThumbnail*) rygel_icon_info_construct (object_type, _tmp0_, _tmp1_);
#line 36 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp2_ = dlna_profile;
#line 36 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
...
#line 39 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	g_return_val_if_fail (didl_item != NULL, NULL);
#line 39 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	g_return_val_if_fail (protocol != NULL, NULL);
#line 41 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp0_ = didl_item;
#line 41 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp1_ = gupnp_didl_lite_object_add_resource ((GUPnPDIDLLiteObject*) _tmp0_);
#line 41 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	res = _tmp1_;
#line 43 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp2_ = ((RygelIconInfo*) self)->uri;
#line 43 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	gupnp_didl_lite_resource_set_uri (res, _tmp2_);
#line 44 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp3_ = ((RygelIconInfo*) self)->size;
#line 44 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	gupnp_didl_lite_resource_set_size64 (res, _tmp3_);
#line 46 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp4_ = ((RygelIconInfo*) self)->width;
#line 46 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	gupnp_didl_lite_resource_set_width (res, _tmp4_);
#line 47 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp5_ = ((RygelIconInfo*) self)->height;
#line 47 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	gupnp_didl_lite_resource_set_height (res, _tmp5_);
#line 48 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp6_ = ((RygelIconInfo*) self)->depth;
#line 48 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	gupnp_didl_lite_resource_set_color_depth (res, _tmp6_);
#line 51 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp7_ = protocol;
#line 51 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
...
#line 53 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	result = res;
#line 53 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	return result;
#line 170 "rygel-thumbnail.c"
}
...
#line 56 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 56 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	g_return_val_if_fail (protocol != NULL, NULL);
#line 57 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp0_ = gupnp_protocol_info_new ();
#line 57 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	protocol_info = _tmp0_;
#line 59 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp1_ = ((RygelIconInfo*) self)->mime_type;
#line 59 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	gupnp_protocol_info_set_mime_type (protocol_info, _tmp1_);
#line 60 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp2_ = self->dlna_profile;
#line 60 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	gupnp_protocol_info_set_dlna_profile (protocol_info, _tmp2_);
#line 61 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_tmp3_ = protocol;
#line 61 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	gupnp_protocol_info_set_protocol (protocol_info, _tmp3_);
#line 62 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
...
#line 66 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	gupnp_protocol_info_set_dlna_operation (protocol_info, GUPNP_DLNA_OPERATION_RANGE);
#line 67 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	gupnp_protocol_info_set_dlna_conversion (protocol_info, GUPNP_DLNA_CONVERSION_TRANSCODED);
#line 69 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	result = protocol_info;
#line 69 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	return result;
#line 226 "rygel-thumbnail.c"
}


static void rygel_thumbnail_class_init (RygelThumbnailClass * klass) {
#line 28 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
...
#line 29 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	_g_free0 (self->dlna_profile);
#line 28 "/home/mryan/src/rygel/src/librygel-server/rygel-thumbnail.vala"
	RYGEL_ICON_INFO_CLASS (rygel_thumbnail_parent_class)->finalize (obj);
#line 253 "rygel-thumbnail.c"
}
