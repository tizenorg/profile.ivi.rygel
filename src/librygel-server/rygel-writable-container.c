/* rygel-writable-container.c generated by valac 0.18.0, the Vala compiler
...
static void rygel_writable_container_real_add_reference (RygelWritableContainer* self, RygelMediaObject* object, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_) {
	...
	_data_->_async_result = g_simple_async_result_new (NULL, _callback_, _user_data_, rygel_writable_container_real_add_reference);
