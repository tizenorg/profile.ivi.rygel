...
#line 40 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	return self ? g_object_ref (self) : NULL;
#line 124 "rygel-subtitle-manager.c"
}
...
#line 40 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	return result;
#line 155 "rygel-subtitle-manager.c"
}
...
#line 1125 "/usr/share/vala-0.16/vapi/glib-2.0.vapi"
	if (_tmp3_ != NULL) {
#line 180 "rygel-subtitle-manager.c"
		gchar* _tmp4_;
...
#line 1128 "/usr/share/vala-0.16/vapi/glib-2.0.vapi"
		return result;
#line 194 "rygel-subtitle-manager.c"
	}
}
...
#line 1374 "/usr/share/vala-0.16/vapi/glib-2.0.vapi"
		start = _tmp3_ + _tmp4_;
#line 239 "rygel-subtitle-manager.c"
	}
#line 1376 "/usr/share/vala-0.16/vapi/glib-2.0.vapi"
	_tmp5_ = end;
#line 1376 "/usr/share/vala-0.16/vapi/glib-2.0.vapi"
	if (_tmp5_ < ((glong) 0)) {
#line 245 "rygel-subtitle-manager.c"
		glong _tmp6_;
		glong _tmp7_;
...
#line 254 "rygel-subtitle-manager.c"
	}
#line 1379 "/usr/share/vala-0.16/vapi/glib-2.0.vapi"
	_tmp9_ = start;
#line 1379 "/usr/share/vala-0.16/vapi/glib-2.0.vapi"
	if (_tmp9_ >= ((glong) 0)) {
#line 260 "rygel-subtitle-manager.c"
		glong _tmp10_;
		glong _tmp11_;
#line 1379 "/usr/share/vala-0.16/vapi/glib-2.0.vapi"
		_tmp10_ = start;
...
#line 292 "rygel-subtitle-manager.c"
	} else {
#line 1380 "/usr/share/vala-0.16/vapi/glib-2.0.vapi"
		_tmp13_ = FALSE;
...
#line 1382 "/usr/share/vala-0.16/vapi/glib-2.0.vapi"
	return result;
#line 320 "rygel-subtitle-manager.c"
}
...
#line 43 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 43 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	g_return_val_if_fail (uri != NULL, NULL);
#line 44 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp0_ = uri;
#line 44 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp1_ = g_file_new_for_uri (_tmp0_);
#line 44 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	video_file = _tmp1_;
#line 46 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp2_ = video_file;
#line 46 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp3_ = g_file_get_parent (_tmp2_);
#line 46 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	directory = _tmp3_;
#line 47 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp4_ = video_file;
#line 47 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp5_ = g_file_get_basename (_tmp4_);
#line 47 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	filename = _tmp5_;
#line 48 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp6_ = filename;
#line 48 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp7_ = string_last_index_of_char (_tmp6_, (gunichar) '.', 0);
#line 48 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	ext_index = _tmp7_;
#line 49 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp8_ = ext_index;
#line 49 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	if (_tmp8_ >= 0) {
#line 391 "rygel-subtitle-manager.c"
		const gchar* _tmp9_;
		gint _tmp10_;
		gchar* _tmp11_ = NULL;
#line 50 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
		_tmp9_ = filename;
#line 50 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
		_tmp10_ = ext_index;
#line 50 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
...
#line 50 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
		filename = _tmp11_;
#line 405 "rygel-subtitle-manager.c"
	}
#line 54 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp12_ = filename;
#line 54 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
...
#line 54 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	filename = _tmp13_;
#line 56 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp14_ = directory;
#line 56 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp15_ = filename;
#line 56 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
...
#line 56 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	srt_file = _tmp16_;
#line 58 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp17_ = srt_file;
#line 58 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
...
#line 58 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
		return NULL;
#line 443 "rygel-subtitle-manager.c"
	}
#line 63 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp19_ = info;
#line 63 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp20_ = g_file_info_get_attribute_boolean (_tmp19_, G_FILE_ATTRIBUTE_ACCESS_CAN_READ);
#line 63 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	if (!_tmp20_) {
#line 451 "rygel-subtitle-manager.c"
		const gchar* _tmp21_ = NULL;
		GError* _tmp22_;
#line 64 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
...
#line 64 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
		return NULL;
#line 474 "rygel-subtitle-manager.c"
	}
#line 68 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp23_ = rygel_subtitle_new ("text/plain", "srt");
#line 68 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	subtitle = _tmp23_;
#line 69 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp24_ = subtitle;
#line 69 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp25_ = srt_file;
#line 69 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
...
#line 69 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp24_->uri = _tmp26_;
#line 70 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp27_ = subtitle;
#line 70 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_tmp28_ = info;
#line 70 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
...
#line 73 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	result = subtitle;
#line 73 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	_g_object_unref0 (info);
#line 73 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
...
#line 73 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	return result;
#line 512 "rygel-subtitle-manager.c"
}


RygelSubtitleManager* rygel_subtitle_manager_construct (GType object_type) {
	RygelSubtitleManager * self = NULL;
#line 32 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	self = (RygelSubtitleManager*) g_object_new (object_type, NULL);
#line 32 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle-manager.vala"
	return self;
#line 522 "rygel-subtitle-manager.c"
}
...
#line 529 "rygel-subtitle-manager.c"
}
...
#line 538 "rygel-subtitle-manager.c"
}
...
#line 552 "rygel-subtitle-manager.c"
}
