/* rygel-panasonic-hacks.c generated by valac 0.18.0, the Vala compiler
...
static void rygel_panasonic_hacks_real_apply (RygelClientHacks* base, RygelMediaItem* item) {
	...
	_tmp0_ = item;
	if (!G_TYPE_CHECK_INSTANCE_TYPE (_tmp0_, RYGEL_TYPE_VISUAL_ITEM)) {
		return;
	}
	{
		...
		_tmp1_ = item;
		_tmp2_ = rygel_visual_item_get_thumbnails (G_TYPE_CHECK_INSTANCE_TYPE (_tmp1_, RYGEL_TYPE_VISUAL_ITEM) ? ((RygelVisualItem*) _tmp1_) : NULL);
		_tmp3_ = _tmp2_;
