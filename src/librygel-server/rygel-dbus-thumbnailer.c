...
void tumbler_Queue (Tumbler* self, gchar** uris, int uris_length1, gchar** mime_types, int mime_types_length1, const gchar* flavor, const gchar* sheduler, guint handle, GAsyncReadyCallback _callback_, gpointer _user_data_) {
#line 24 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
static void _rygel_dbus_thumbnailer_on_activatable_names_gasync_ready_callback (GObject* source_object, GAsyncResult* res, gpointer self) {
#line 62 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 51 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	g_return_val_if_fail (flavor != NULL, NULL);
#line 51 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	self = (RygelDbusThumbnailer*) g_object_new (object_type, NULL);
#line 53 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp0_ = gee_array_list_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, NULL);
#line 53 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_g_object_unref0 (self->priv->uris);
#line 53 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	self->priv->uris = _tmp0_;
#line 54 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 55 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	self->priv->timeout_id = (guint) 0;
#line 56 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp2_ = flavor;
#line 56 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 58 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 79 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	return result;
...
void rygel_dbus_thumbnailer_queue_thumbnail_task (RygelDbusThumbnailer* self, const gchar* uri, const gchar* mime) {
	...
	gint _tmp11_;
	gint _tmp12_;
#line 65 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	g_return_if_fail (self != NULL);
#line 65 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	g_return_if_fail (uri != NULL);
#line 65 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	g_return_if_fail (mime != NULL);
#line 66 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp0_ = uri;
#line 66 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp1_ = g_file_new_for_uri (_tmp0_);
#line 66 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	file = _tmp1_;
#line 67 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp2_ = file;
#line 67 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp3_ = g_file_is_native (_tmp2_);
#line 67 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	if (!_tmp3_) {
#line 68 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
		_g_object_unref0 (file);
#line 68 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
		return;
#line 566 "rygel-dbus-thumbnailer.c"
	}
#line 70 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp4_ = self->priv->uris;
#line 70 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp5_ = uri;
#line 70 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp4_, _tmp5_);
#line 71 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp6_ = self->priv->mimes;
#line 71 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp7_ = mime;
#line 71 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp6_, _tmp7_);
#line 73 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp8_ = self->priv->timeout_id;
#line 73 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	if (_tmp8_ != ((guint) 0)) {
#line 584 "rygel-dbus-thumbnailer.c"
		guint _tmp9_;
#line 74 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
		_tmp9_ = self->priv->timeout_id;
#line 74 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
		g_source_remove (_tmp9_);
#line 590 "rygel-dbus-thumbnailer.c"
	}
#line 77 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 82 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 86 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 87 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp0_ = self->priv->tumbler;
#line 87 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	if (_tmp0_ == NULL) {
#line 89 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
		result = TRUE;
#line 89 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
		return result;
#line 648 "rygel-dbus-thumbnailer.c"
	}
#line 92 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
"es", _tmp3_);
#line 95 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 101 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp14_ = self->priv->uris;
#line 101 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	gee_abstract_collection_clear ((GeeAbstractCollection*) _tmp14_);
#line 102 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_tmp15_ = self->priv->mimes;
#line 102 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	gee_abstract_collection_clear ((GeeAbstractCollection*) _tmp15_);
#line 103 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	self->priv->timeout_id = (guint) 0;
#line 105 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	result = FALSE;
#line 105 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	return result;
...
static gboolean _vala_string_array_contains (gchar** stack, int stack_length, gchar* needle) {
	int i;
#line 111 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
static void rygel_dbus_thumbnailer_on_activatable_names (RygelDbusThumbnailer* self, GObject* source, GAsyncResult* res) {
	Tumbler* _tmp8_;
	GError * _inner_error_ = NULL;
#line 108 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	g_return_if_fail (self != NULL);
#line 108 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 726 "rygel-dbus-thumbnailer.c"
	{
		...
		gchar** _tmp4_;
		gint _tmp4__length1;
#line 110 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 775 "rygel-dbus-thumbnailer.c"
			Tumbler* _tmp5_ = NULL;
			Tumbler* _tmp6_;
#line 112 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 116 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 109 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
		names = (_vala_array_free (names, names_length1, (GDestroyNotify) g_free), NULL);
...
#line 122 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 34 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
...
#line 35 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_g_object_unref0 (self->priv->tumbler);
#line 36 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_g_object_unref0 (self->priv->uris);
#line 37 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_g_object_unref0 (self->priv->mimes);
#line 39 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_g_free0 (self->priv->flavor);
#line 40 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
	_g_object_unref0 (self->priv->fdo);
#line 34 "/home/mryan/src/rygel/src/librygel-server/rygel-dbus-thumbnailer.vala"
