...
RygelSubtitle* rygel_subtitle_construct (GType object_type, const gchar* mime_type, const gchar* caption_type) {
	...
	const gchar* _tmp2_;
	gchar* _tmp3_;
#line 37 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	g_return_val_if_fail (mime_type != NULL, NULL);
#line 37 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	g_return_val_if_fail (caption_type != NULL, NULL);
#line 37 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	self = (RygelSubtitle*) g_type_create_instance (object_type);
#line 39 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	_tmp0_ = mime_type;
#line 39 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
...
#line 40 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	_tmp2_ = caption_type;
#line 40 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
...
void rygel_subtitle_add_didl_node (RygelSubtitle* self, GUPnPDIDLLiteItem* didl_item) {
	...
	xmlNode* sec_node;
	const gchar* _tmp8_;
#line 43 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	g_return_if_fail (self != NULL);
#line 43 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	g_return_if_fail (didl_item != NULL);
#line 44 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	_tmp0_ = didl_item;
#line 44 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
...
#line 44 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	item_node = _tmp2_;
#line 45 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	_tmp3_ = item_node->doc;
#line 45 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	_tmp4_ = xmlDocGetRootElement (_tmp3_);
#line 45 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	root_node = _tmp4_;
#line 47 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	_tmp5_ = xmlNewNs (root_node, "http://www.sec.co.kr/", "sec");
#line 47 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	sec_ns = _tmp5_;
#line 48 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	_tmp6_ = self->uri;
#line 48 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	_tmp7_ = xmlNewChild (item_node, sec_ns, "CaptionInfoEx", _tmp6_);
#line 48 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	sec_node = _tmp7_;
#line 52 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	_tmp8_ = self->caption_type;
#line 52 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	xmlNewProp (sec_node, "sec:type", _tmp8_);
#line 177 "rygel-subtitle.c"
}


static void rygel_value_subtitle_init (GValue* value) {
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	value->data[0].v_pointer = NULL;
#line 184 "rygel-subtitle.c"
}
...
#line 203 "rygel-subtitle.c"
	} else {
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
		dest_value->data[0].v_pointer = NULL;
#line 207 "rygel-subtitle.c"
	}
}
...
#line 233 "rygel-subtitle.c"
		}
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
		value->data[0].v_pointer = rygel_subtitle_ref (object);
#line 237 "rygel-subtitle.c"
	} else {
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
		value->data[0].v_pointer = NULL;
#line 241 "rygel-subtitle.c"
	}
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	return NULL;
...
#line 256 "rygel-subtitle.c"
	}
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	if (!value->data[0].v_pointer) {
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
		*object_p = NULL;
#line 262 "rygel-subtitle.c"
	} else if (collect_flags & G_VALUE_NOCOPY_CONTENTS) {
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
		*object_p = value->data[0].v_pointer;
#line 266 "rygel-subtitle.c"
	} else {
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
		*object_p = rygel_subtitle_ref (value->data[0].v_pointer);
#line 270 "rygel-subtitle.c"
	}
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	return NULL;
...
#line 317 "rygel-subtitle.c"
	} else {
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
		value->data[0].v_pointer = NULL;
#line 321 "rygel-subtitle.c"
	}
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	if (old) {
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
...
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
		value->data[0].v_pointer = v_object;
#line 346 "rygel-subtitle.c"
	} else {
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
		value->data[0].v_pointer = NULL;
#line 350 "rygel-subtitle.c"
	}
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	if (old) {
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
...
#line 366 "rygel-subtitle.c"
}


static void rygel_subtitle_instance_init (RygelSubtitle * self) {
#line 35 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	self->size = (gint64) (-1);
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	self->ref_count = 1;
#line 375 "rygel-subtitle.c"
}
...
#line 31 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	_g_free0 (self->uri);
#line 32 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	_g_free0 (self->mime_type);
#line 33 "/home/mryan/src/rygel/src/librygel-server/rygel-subtitle.vala"
	_g_free0 (self->caption_type);
