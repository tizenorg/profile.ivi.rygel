	...
	if (_tmp3_ == ((0 != _tmp2_label0) ? _tmp2_label0 : (_tmp2_label0 = g_quark_from_static_string ("@id")))) {
		...
		switch (0) {
			default:
			{
				...
				_tmp55_ = rygel_photo_item_get_creator (G_TYPE_CHECK_INSTANCE_TYPE (_tmp54_, RYGEL_TYPE_PHOTO_ITEM) ? ((RygelPhotoItem*) _tmp54_) : NULL);
				_tmp56_ = _tmp55_;
		...
		switch (0) {
			default:
			{
				RygelMediaObject* _tmp68_;
				RygelMediaObject* _tmp69_;
				RygelMediaContainer* _tmp70_;
				RygelMediaContainer* container;
				RygelMediaContainer* _tmp71_;
				gint _tmp72_;
				gint _tmp73_;
