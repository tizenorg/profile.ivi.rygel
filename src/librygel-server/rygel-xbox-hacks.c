/* rygel-xbox-hacks.c generated by valac 0.18.0, the Vala compiler
...
static void rygel_xbox_hacks_real_apply (RygelClientHacks* base, RygelMediaItem* item) {
	...
	_tmp2_ = _tmp1_;
	if (g_strcmp0 (_tmp2_, "video/x-msvideo") == 0) {
		RygelMediaItem* _tmp3_;
		_tmp3_ = item;
		rygel_media_item_set_mime_type (_tmp3_, "video/avi");
	} else {
		...
		_tmp6_ = _tmp5_;
		if (g_strcmp0 (_tmp6_, "video/mpeg") == 0) {
			RygelMediaItem* _tmp7_;
			_tmp7_ = item;
			rygel_media_item_set_mime_type (_tmp7_, "invalid/content");
		}
	}
}
