/* rygel-media-item.c generated by valac 0.18.0, the Vala compiler
	...
	if (_tmp5_ != NULL) {
		{
			...
			gchar* _tmp12_;
			gchar* _tmp13_;
			_tmp6_ = rygel_media_item_address_regex;
...
static void rygel_media_item_real_apply_didl_lite (RygelMediaObject* base, GUPnPDIDLLiteObject* didl_object) {
	...
	_tmp3_ = _tmp2_;
	rygel_media_item_set_date (self, _tmp3_);
	_tmp4_ = didl_object;
	_tmp5_ = gupnp_didl_lite_object_get_description (_tmp4_);
	_tmp6_ = _tmp5_;
	rygel_media_item_set_description (self, _tmp6_);
}
...
static GUPnPDIDLLiteObject* rygel_media_item_real_serialize (RygelMediaObject* base, RygelSerializer* serializer, RygelHTTPServer* http_server, GError** error) {
	...
	_tmp34_ = self->priv->_description;
	if (_tmp34_ != NULL) {
		GUPnPDIDLLiteItem* _tmp35_;
		const gchar* _tmp36_;
		_tmp35_ = didl_item;
		_tmp36_ = self->priv->_description;
		gupnp_didl_lite_object_set_description ((GUPnPDIDLLiteObject*) _tmp35_, _tmp36_);
	}
	if (G_TYPE_CHECK_INSTANCE_TYPE (self, RYGEL_TYPE_TRACKABLE_ITEM)) {
		...
		guint _tmp39_;
		_tmp37_ = didl_item;
		_tmp38_ = rygel_media_object_get_object_update_id ((RygelMediaObject*) self);
		_tmp39_ = _tmp38_;
		gupnp_didl_lite_object_set_update_id ((GUPnPDIDLLiteObject*) _tmp37_, _tmp39_);
	}
	_tmp40_ = http_server;
	_tmp41_ = didl_item;
	rygel_media_item_add_proxy_resources (self, _tmp40_, _tmp41_, &_inner_error_);
	if (_inner_error_ != NULL) {
		g_propagate_error (error, _inner_error_);
		_g_object_unref0 (didl_item);
		return NULL;
	}
	_tmp42_ = self->priv->_place_holder;
	if (!_tmp42_) {
		RygelHTTPServer* _tmp43_;
		GUPnPContext* _tmp44_;
		const gchar* _tmp45_;
		const gchar* _tmp46_;
		gchar* _tmp47_;
		gchar* host_ip;
		...
		GList* _tmp58_ = NULL;
		_tmp43_ = http_server;
		_tmp44_ = _tmp43_->context;
		_tmp45_ = gssdp_client_get_host_ip ((GSSDPClient*) _tmp44_);
		_tmp46_ = _tmp45_;
		_tmp47_ = g_strdup (_tmp46_);
		host_ip = _tmp47_;
		_tmp49_ = http_server;
		_tmp50_ = _tmp49_->context;
		_tmp51_ = gssdp_client_get_interface ((GSSDPClient*) _tmp50_);
		_tmp52_ = _tmp51_;
		if (g_strcmp0 (_tmp52_, "lo") == 0) {
			_tmp48_ = TRUE;
		} else {
			const gchar* _tmp53_;
			_tmp53_ = host_ip;
			_tmp48_ = g_strcmp0 (_tmp53_, "127.0.0.1") == 0;
		}
		_tmp54_ = _tmp48_;
		internal_allowed = _tmp54_;
		_tmp55_ = didl_item;
		_tmp56_ = internal_allowed;
		rygel_media_item_add_resources (self, _tmp55_, _tmp56_, &_inner_error_);
		if (_inner_error_ != NULL) {
			g_propagate_error (error, _inner_error_);
			_g_free0 (host_ip);
			_g_object_unref0 (didl_item);
		...
		_tmp57_ = didl_item;
		_tmp58_ = gupnp_didl_lite_object_get_resources ((GUPnPDIDLLiteObject*) _tmp57_);
		{
			GList* res_collection = NULL;
			GList* res_it = NULL;
			res_collection = _tmp58_;
			for (res_it = res_collection; res_it != NULL; res_it = res_it->next) {
				GUPnPDIDLLiteResource* _tmp59_;
				GUPnPDIDLLiteResource* res = NULL;
				_tmp59_ = _g_object_ref0 ((GUPnPDIDLLiteResource*) res_it->data);
				res = _tmp59_;
				{
					GRegex* _tmp60_;
					GUPnPDIDLLiteResource* _tmp61_;
					const gchar* _tmp62_;
					const gchar* _tmp63_;
					const gchar* _tmp64_;
					gchar* _tmp65_ = NULL;
					gchar* _tmp66_;
					GUPnPDIDLLiteResource* _tmp67_;
					gchar* _tmp68_;
					_tmp60_ = rygel_media_item_address_regex;
					_tmp61_ = res;
					_tmp62_ = gupnp_didl_lite_resource_get_uri (_tmp61_);
					_tmp63_ = _tmp62_;
					_tmp64_ = host_ip;
					_tmp65_ = g_regex_replace_literal (_tmp60_, _tmp63_, (gssize) (-1), 0, _tmp64_, 0, &_inner_error_);
					_tmp66_ = _tmp65_;
					if (_inner_error_ != NULL) {
						g_propagate_error (error, _inner_error_);
					...
					_tmp67_ = res;
					_tmp68_ = _tmp66_;
					gupnp_didl_lite_resource_set_uri (_tmp67_, _tmp68_);
					_g_free0 (_tmp68_);
					_g_object_unref0 (res);
				}
			}
...
static void rygel_media_item_class_init (RygelMediaItemClass * klass) {
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), RYGEL_MEDIA_ITEM_OCM_FLAGS, g_param_spec_flags ("ocm-flags", "ocm-flags", "ocm-flags", gupnp_ocm_flags_get_type (), 0, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	{
		...
		GRegex* _tmp3_;
		GRegex* _tmp4_;
		_tmp0_ = g_regex_escape_string ("@ADDRESS@", -1);
		_tmp1_ = _tmp0_;
		...
		rygel_media_item_address_regex = _tmp4_;
	}
	goto __finally9;
