/* rygel-last-change-obj-add.c generated by valac 0.16.1, the Vala compiler
...
RygelLastChangeObjAdd* rygel_last_change_obj_add_construct (GType object_type, const gchar* id, guint update_id, gboolean sub_tree_update, const gchar* parent_id, const gchar* upnp_class) {
	...
	const gchar* _tmp5_;
	gchar* _tmp6_;
#line 29 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	g_return_val_if_fail (id != NULL, NULL);
#line 29 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	g_return_val_if_fail (parent_id != NULL, NULL);
#line 29 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	g_return_val_if_fail (upnp_class != NULL, NULL);
#line 34 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	_tmp0_ = id;
#line 34 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	_tmp1_ = update_id;
#line 34 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	self = (RygelLastChangeObjAdd*) rygel_last_change_entry_construct (object_type, "objAdd", _tmp0_, _tmp1_);
#line 35 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	_tmp2_ = sub_tree_update;
#line 35 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	self->priv->sub_tree_update = _tmp2_;
#line 36 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	_tmp3_ = parent_id;
#line 36 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
...
#line 37 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	_tmp5_ = upnp_class;
#line 37 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
...
static gchar* rygel_last_change_obj_add_real_additional_info (RygelLastChangeEntry* base) {
	...
	const gchar* _tmp25_;
	gchar* _tmp26_;
#line 40 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	self = (RygelLastChangeObjAdd*) base;
#line 42 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	_tmp0_ = g_string_new ("");
#line 42 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	str = _tmp0_;
#line 43 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
...
#line 43 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	st_update = _tmp4_;
#line 45 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	_tmp5_ = str;
#line 45 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
...
#line 45 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	_g_free0 (_tmp7_);
#line 49 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	_tmp24_ = str;
#line 49 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	_tmp25_ = _tmp24_->str;
#line 49 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
...
#line 24 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
...
static void rygel_last_change_obj_add_finalize (GObject* obj) {
	RygelLastChangeObjAdd * self;
#line 24 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	self = RYGEL_LAST_CHANGE_OBJ_ADD (obj);
#line 26 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	_g_free0 (self->priv->parent_id);
#line 27 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
	_g_free0 (self->priv->upnp_class);
#line 24 "/home/mryan/src/rygel/src/librygel-server/rygel-last-change-obj-add.vala"
