...
RygelImageItem* rygel_image_item_construct (GType object_type, const gchar* id, RygelMediaContainer* parent, const gchar* title, const gchar* upnp_class) {
	...
	GeeArrayList* _tmp4_;
	GeeArrayList* _tmp5_;
#line 61 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
#line 65 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp0_ = id;
#line 65 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp1_ = parent;
#line 65 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
#line 67 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
#line 70 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	self = (RygelImageItem*) base;
#line 71 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	result = FALSE;
#line 71 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	return result;
...
static void rygel_image_item_real_add_uri (RygelMediaItem* base, const gchar* uri) {
	...
	const gchar* _tmp1_;
	const gchar* _tmp2_;
#line 74 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	self = (RygelImageItem*) base;
#line 74 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	g_return_if_fail (uri != NULL);
#line 75 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp0_ = uri;
#line 75 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	RYGEL_MEDIA_ITEM_CLASS (rygel_image_item_parent_class)->add_uri (RYGEL_MEDIA_ITEM (self), _tmp0_);
#line 77 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp1_ = uri;
#line 77 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp2_ = ((RygelMediaItem*) self)->mime_type;
#line 77 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	rygel_visual_item_add_thumbnail_for_uri ((RygelVisualItem*) self, _tmp1_, _tmp2_);
#line 349 "rygel-image-item.c"
}
...
#line 80 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	self = (RygelImageItem*) base;
#line 80 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	g_return_if_fail (didl_item != NULL);
#line 83 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp0_ = didl_item;
#line 83 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
#line 85 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp2_ = didl_item;
#line 85 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
static GUPnPDIDLLiteResource* rygel_image_item_real_add_resource (RygelMediaItem* base, GUPnPDIDLLiteItem* didl_item, const gchar* uri, const gchar* protocol, const gchar* import_uri, GError** error) {
	...
	GError * _inner_error_ = NULL;
#line 88 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	self = (RygelImageItem*) base;
#line 88 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	g_return_val_if_fail (didl_item != NULL, NULL);
#line 88 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	g_return_val_if_fail (protocol != NULL, NULL);
#line 94 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp0_ = didl_item;
#line 94 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp1_ = uri;
#line 94 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
#line 94 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
		return NULL;
#line 429 "rygel-image-item.c"
	}
#line 96 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	rygel_visual_item_add_visual_props ((RygelVisualItem*) self, res);
#line 98 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	result = res;
#line 98 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	return result;
#line 437 "rygel-image-item.c"
}
...
static void rygel_image_item_real_add_proxy_resources (RygelMediaItem* base, RygelHTTPServer* server, GUPnPDIDLLiteItem* didl_item, GError** error) {
	...
	gboolean _tmp3_;
	GError * _inner_error_ = NULL;
#line 101 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	self = (RygelImageItem*) base;
#line 101 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	g_return_if_fail (server != NULL);
#line 101 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	g_return_if_fail (didl_item != NULL);
#line 104 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp0_ = server;
#line 104 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp1_ = didl_item;
#line 104 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
#line 104 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
		return;
#line 466 "rygel-image-item.c"
	}
#line 106 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp2_ = rygel_media_item_get_place_holder ((RygelMediaItem*) self);
#line 106 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp3_ = _tmp2_;
#line 106 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	if (!_tmp3_) {
#line 474 "rygel-image-item.c"
		RygelHTTPServer* _tmp4_;
		GUPnPDIDLLiteItem* _tmp5_;
#line 108 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
		_tmp4_ = server;
#line 108 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
		_tmp5_ = didl_item;
#line 108 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
#line 112 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	self = (RygelImageItem*) base;
#line 112 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	g_return_val_if_fail (protocol != NULL, NULL);
#line 114 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp0_ = uri;
#line 114 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	_tmp1_ = protocol;
#line 114 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
#line 116 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
#line 118 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	result = protocol_info;
#line 118 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	return result;
#line 526 "rygel-image-item.c"
}
...
static gint rygel_image_item_real_get_width (RygelVisualItem* base) {
	...
	RygelImageItem* self;
	gint _tmp0_;
#line 42 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	self = (RygelImageItem*) base;
#line 42 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
static gint rygel_image_item_real_get_height (RygelVisualItem* base) {
	...
	RygelImageItem* self;
	gint _tmp0_;
#line 48 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	self = (RygelImageItem*) base;
#line 48 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
static gint rygel_image_item_real_get_color_depth (RygelVisualItem* base) {
	...
	RygelImageItem* self;
	gint _tmp0_;
#line 54 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	self = (RygelImageItem*) base;
#line 54 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
static GeeArrayList* rygel_image_item_real_get_thumbnails (RygelVisualItem* base) {
	...
	RygelImageItem* self;
	GeeArrayList* _tmp0_;
#line 59 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
	self = (RygelImageItem*) base;
#line 59 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
#line 662 "rygel-image-item.c"
}


static void rygel_image_item_class_init (RygelImageItemClass * klass) {
#line 32 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
...
#line 32 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
		break;
#line 814 "rygel-image-item.c"
		default:
#line 32 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
#line 32 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
		break;
#line 820 "rygel-image-item.c"
	}
}
...
#line 32 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
		break;
#line 854 "rygel-image-item.c"
		default:
#line 32 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
#line 32 "/home/mryan/src/rygel/src/librygel-server/rygel-image-item.vala"
		break;
#line 860 "rygel-image-item.c"
	}
}
