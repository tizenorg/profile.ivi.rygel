...
static gboolean rygel_search_expression_real_satisfied_by (RygelSearchExpression* self, RygelMediaObject* media_object) {
#line 32 "/home/mryan/src/rygel/src/librygel-server/rygel-search-expression.vala"
...
static gchar* rygel_search_expression_real_to_string (RygelSearchExpression* self) {
#line 34 "/home/mryan/src/rygel/src/librygel-server/rygel-search-expression.vala"
...
#line 26 "/home/mryan/src/rygel/src/librygel-server/rygel-search-expression.vala"
...
#line 27 "/home/mryan/src/rygel/src/librygel-server/rygel-search-expression.vala"
	((self->op == NULL) || (self->priv->g_destroy_func == NULL)) ? NULL : (self->op = (self->priv->g_destroy_func (self->op), NULL));
#line 29 "/home/mryan/src/rygel/src/librygel-server/rygel-search-expression.vala"
	((self->operand1 == NULL) || (self->priv->h_destroy_func == NULL)) ? NULL : (self->operand1 = (self->priv->h_destroy_func (self->operand1), NULL));
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-search-expression.vala"
