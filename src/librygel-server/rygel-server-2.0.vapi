/* rygel-server-2.0.vapi generated by valac 0.16.1, do not modify. */
...
namespace Rygel {
	...
	public abstract class MediaContainer : Rygel.MediaObject {
		...
		public void updated (Rygel.MediaObject object = @this, Rygel.ObjectEventType event_type = ObjectEventType.MODIFIED, bool sub_tree_update = false);
	...
	public abstract class MediaServerPlugin : Rygel.Plugin {
		...
		public Rygel.MediaContainer root_container { get; private set; }
	}
	[CCode (cheader_filename = "rygel-server.h")]
	...
	public abstract class TranscodeManager : GLib.Object {
		...
		public abstract string create_uri_for_item (Rygel.MediaItem item, int thumbnail_index, int subtitle_index, string? transcode_target);
	...
	public interface TrackableContainer : Rygel.MediaContainer {
		public abstract async void add_child (Rygel.MediaObject object);
		public async void add_child_tracked (Rygel.MediaObject object);
		public async void clear ();
		public abstract async void remove_child (Rygel.MediaObject object);
