/* rygel-samsung-tv-hacks.c generated by valac 0.18.0, the Vala compiler
...
static void rygel_samsung_tv_hacks_real_apply (RygelClientHacks* base, RygelMediaItem* item);
...
static void rygel_samsung_tv_hacks_real_apply (RygelClientHacks* base, RygelMediaItem* item) {
	...
	_tmp0_ = item;
	_tmp1_ = rygel_media_item_get_mime_type (_tmp0_);
	_tmp2_ = _tmp1_;
	if (g_strcmp0 (_tmp2_, "video/x-matroska") == 0) {
		RygelMediaItem* _tmp3_;
		_tmp3_ = item;
		rygel_media_item_set_mime_type (_tmp3_, "video/x-mkv");
	}
}
