/* rygel-http-identity-handler.c generated by valac 0.18.0, the Vala compiler
...
static GUPnPDIDLLiteResource* rygel_http_identity_handler_real_add_resource (RygelHTTPGetHandler* base, GUPnPDIDLLiteObject* didl_object, RygelHTTPGet* request, GError** error) {
	...
	if (_tmp4_ != NULL) {
		...
		_tmp12_ = didl_object;
		_tmp13_ = protocol;
		_tmp14_ = rygel_media_object_add_resource (_tmp11_, _tmp12_, NULL, _tmp13_, NULL, &_inner_error_);
		_tmp15_ = _tmp14_;
		if (_inner_error_ != NULL) {
			g_propagate_error (error, _inner_error_);
			_g_free0 (protocol);
