/* rygel-reference-creator.c generated by valac 0.18.0, the Vala compiler
...
static gboolean rygel_reference_creator_real_run_co (RygelReferenceCreatorRunData* _data_) {
	...
	__catch51_g_error:
	{
		...
		gupnp_service_action_return_error (_data_->_tmp20_, (guint) _data_->_tmp22_, _data_->_tmp24_);
		_data_->_tmp25_ = NULL;
		_data_->_tmp25_ = _ ("Failed to create object under '%s': %s");
		_data_->_tmp26_ = _data_->self->container_id;
...
static gboolean rygel_reference_creator_fetch_container_co (RygelReferenceCreatorFetchContainerData* _data_) {
	...
	_data_->_tmp4_ = _data_->self->container_id;
	_data_->_tmp5_ = rygel_state_machine_get_cancellable ((RygelStateMachine*) _data_->self);
	_data_->_tmp6_ = _data_->_tmp5_;
	_data_->_state_ = 1;
	rygel_media_container_find_object (_data_->_tmp3_, _data_->_tmp4_, _data_->_tmp6_, rygel_reference_creator_fetch_container_ready, _data_);
	return FALSE;
	_state_1:
	_data_->_tmp7_ = NULL;
