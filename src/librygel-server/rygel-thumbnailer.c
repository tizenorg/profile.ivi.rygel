/* rygel-thumbnailer.c generated by valac 0.18.0, the Vala compiler
...
RygelThumbnail* rygel_thumbnailer_get_thumbnail (RygelThumbnailer* self, const gchar* uri, const gchar* mime_type, GError** error) {
	...
	gint _tmp48_;
	RygelThumbnail* _tmp49_;
	RygelThumbnail* _tmp50_;
	gint _tmp51_;
	const gchar* _tmp52_;
	gchar* _tmp53_ = NULL;
	gchar* _tmp54_;
	RygelThumbnail* _tmp55_;
	RygelThumbnail* _tmp56_;
	GFileInfo* _tmp57_;
	...
	_tmp52_ = path;
	_tmp53_ = g_filename_to_uri (_tmp52_, NULL, &_inner_error_);
	_tmp54_ = _tmp53_;
	if (_inner_error_ != NULL) {
		g_propagate_error (error, _inner_error_);
	...
	((RygelIconInfo*) _tmp55_)->uri = _tmp54_;
	_tmp56_ = thumbnail;
	_tmp57_ = info;
