/* rygel-http-playlist-handler.c generated by valac 0.18.0, the Vala compiler
...
RygelPlaylistDatasource* rygel_playlist_datasource_new (RygelMediaContainer* container, RygelHTTPServer* server, RygelClientHacks* hacks);
RygelPlaylistDatasource* rygel_playlist_datasource_construct (GType object_type, RygelMediaContainer* container, RygelHTTPServer* server, RygelClientHacks* hacks);
...
RygelHTTPPlaylistHandler* rygel_http_playlist_handler_new (GCancellable* cancellable);
RygelHTTPPlaylistHandler* rygel_http_playlist_handler_construct (GType object_type, GCancellable* cancellable);
...
RygelPlaylistDatasource* rygel_playlist_datasource_new (RygelMediaContainer* container, RygelHTTPServer* server, RygelClientHacks* hacks) {
	return rygel_playlist_datasource_construct (RYGEL_TYPE_PLAYLIST_DATASOURCE, container, server, hacks);
}
...
static gboolean rygel_playlist_datasource_generate_data_co (RygelPlaylistDatasourceGenerateDataData* _data_) {
	...
	_state_0:
	{
		...
		if (_data_->_tmp11_ != NULL) {
			_data_->_tmp12_ = rygel_serializer_new (SERIALIZER_TYPE_DIDL_S);
			...
			_data_->_tmp23_ = NULL;
			_data_->_tmp23_ = _ ("Failed to generate playlist");
			_data_->_tmp24_ = g_error_new_literal (RYGEL_DATA_SOURCE_ERROR, RYGEL_DATA_SOURCE_ERROR_GENERAL, _data_->_tmp23_);
			_data_->_tmp25_ = _data_->_tmp24_;
			g_signal_emit_by_name ((RygelDataSource*) _data_->self, "error", _data_->_tmp25_);
			_g_error_free0 (_data_->_tmp25_);
		}
		_g_object_unref0 (_data_->children);
		_g_free0 (_data_->sort_criteria);
	}
	...
	__catch28_g_error:
	{
		...
		g_warning ("rygel-http-playlist-handler.vala:97: Could not generate playlist: %s", _data_->_tmp27_);
...
RygelHTTPPlaylistHandler* rygel_http_playlist_handler_new (GCancellable* cancellable) {
	return rygel_http_playlist_handler_construct (RYGEL_TYPE_HTTP_PLAYLIST_HANDLER, cancellable);
}
...
static void rygel_http_playlist_handler_real_add_response_headers (RygelHTTPGetHandler* base, RygelHTTPGet* request, GError** error) {
	...
	soup_message_headers_append (_tmp2_, "Content-Type", "text/xml");
	_tmp3_ = request;
	RYGEL_HTTP_GET_HANDLER_CLASS (rygel_http_playlist_handler_parent_class)->add_response_headers (G_TYPE_CHECK_INSTANCE_CAST (self, RYGEL_TYPE_HTTP_GET_HANDLER, RygelHTTPGetHandler), _tmp3_, &_inner_error_);
	if (_inner_error_ != NULL) {
...
static RygelHTTPResponse* rygel_http_playlist_handler_real_render_body (RygelHTTPGetHandler* base, RygelHTTPGet* request, GError** error) {
	...
	g_return_val_if_fail (request != NULL, NULL);
	{
		...
		RygelHTTPGet* _tmp4_;
		RygelClientHacks* _tmp5_;
		RygelPlaylistDatasource* _tmp6_;
		RygelPlaylistDatasource* source;
		RygelHTTPGet* _tmp7_;
		RygelPlaylistDatasource* _tmp8_;
		RygelHTTPResponse* _tmp9_;
		RygelHTTPResponse* _tmp10_;
		_tmp0_ = request;
		_tmp1_ = ((RygelHTTPRequest*) _tmp0_)->object;
		_tmp2_ = request;
		_tmp3_ = ((RygelHTTPRequest*) _tmp2_)->http_server;
		_tmp4_ = request;
		_tmp5_ = ((RygelHTTPRequest*) _tmp4_)->hack;
		_tmp6_ = rygel_playlist_datasource_new (G_TYPE_CHECK_INSTANCE_TYPE (_tmp1_, RYGEL_TYPE_MEDIA_CONTAINER) ? ((RygelMediaContainer*) _tmp1_) : NULL, _tmp3_, _tmp5_);
		source = _tmp6_;
		_tmp7_ = request;
		_tmp8_ = source;
		_tmp9_ = rygel_http_response_new (_tmp7_, (RygelHTTPGetHandler*) self, (RygelDataSource*) _tmp8_, &_inner_error_);
		_tmp10_ = _tmp9_;
		if (_inner_error_ != NULL) {
...
static GUPnPDIDLLiteResource* rygel_http_playlist_handler_real_add_resource (RygelHTTPGetHandler* base, GUPnPDIDLLiteObject* didl_object, RygelHTTPGet* request, GError** error) {
	...
	protocol = _tmp2_;
	g_debug ("rygel-http-playlist-handler.vala:137: => Protocol of this http server " \
"is: %s", protocol);
	{
		RygelHTTPGet* _tmp3_;
	...
	__catch30_g_error:
	{
		...
		_error_ = _inner_error_;
		_inner_error_ = NULL;
		_tmp8_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (NULL, gupnp_didl_lite_resource_get_type ()) ? ((GUPnPDIDLLiteResource*) NULL) : NULL);
		result = _tmp8_;
		_g_error_free0 (_error_);
		_g_free0 (protocol);
		return result;
