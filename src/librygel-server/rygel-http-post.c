/* rygel-http-post.c generated by valac 0.18.0, the Vala compiler
...
static gboolean rygel_http_post_handle_real_co (RygelHttpPostHandleRealData* _data_) {
	...
	_data_->_tmp10_ = ((RygelHTTPRequest*) _data_->self)->object;
	_data_->_tmp11_ = rygel_state_machine_get_cancellable ((RygelStateMachine*) _data_->self);
	_data_->_tmp12_ = _data_->_tmp11_;
	_data_->_state_ = 1;
	rygel_media_object_get_writable ((RygelMediaObject*) (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp10_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _data_->_tmp10_) : NULL), _data_->_tmp12_, rygel_http_post_handle_real_ready, _data_);
	return FALSE;
	_state_1:
	_data_->_tmp13_ = NULL;
	_data_->_tmp13_ = rygel_media_object_get_writable_finish ((RygelMediaObject*) (G_TYPE_CHECK_INSTANCE_TYPE (_data_->_tmp10_, RYGEL_TYPE_MEDIA_ITEM) ? ((RygelMediaItem*) _data_->_tmp10_) : NULL), _data_->_res_, &_data_->_inner_error_);
...
static gboolean rygel_http_post_wait_for_item_co (RygelHttpPostWaitForItemData* _data_) {
	...
	while (TRUE) {
		...
		_data_->_tmp16_ = rygel_media_item_get_place_holder (_data_->_tmp15_);
		...
		if (_data_->_tmp17_) {
			...
			_data_->_tmp18_ = _data_->timeout;
			_data_->_tmp19_ = 0U;
			_data_->_tmp19_ = g_timeout_add_seconds_full (G_PRIORITY_DEFAULT, _data_->_tmp18_, _____lambda17__gsource_func, block7_data_ref (_data_->_data7_), block7_data_unref);
			_data_->_data7_->source_id = _data_->_tmp19_;
			_data_->_tmp20_ = _data_->_data6_->container;
			_data_->_tmp21_ = 0UL;
			_data_->_tmp21_ = g_signal_connect_data (_data_->_tmp20_, "container-updated", (GCallback) _____lambda18__rygel_media_container_container_updated, block7_data_ref (_data_->_data7_), (GClosureNotify) block7_data_unref, 0);
			_data_->update_id = _data_->_tmp21_;
			_data_->_state_ = 2;
			return FALSE;
			_state_2:
			;
			_data_->_tmp22_ = _data_->_data6_->container;
			_data_->_tmp23_ = _data_->update_id;
			g_signal_handler_disconnect ((GObject*) _data_->_tmp22_, _data_->_tmp23_);
			_data_->_tmp24_ = _data_->_data7_->source_id;
			if (_data_->_tmp24_ != ((guint) 0)) {
				_data_->_tmp25_ = _data_->_data7_->source_id;
				g_source_remove (_data_->_tmp25_);
			} else {
