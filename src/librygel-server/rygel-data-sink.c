/* rygel-data-sink.c generated by valac 0.16.1, the Vala compiler
...
#line 44 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
static void _rygel_data_sink_on_data_available_rygel_data_source_data_available (RygelDataSource* _sender, guint8* data, int data_length1, gpointer self) {
#line 56 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
static void _rygel_data_sink_on_wrote_chunk_soup_message_wrote_chunk (SoupMessage* _sender, gpointer self) {
#line 57 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
RygelDataSink* rygel_data_sink_construct (GType object_type, RygelDataSource* source, SoupServer* server, SoupMessage* message, RygelHTTPSeek* offsets) {
	...
	SoupMessage* _tmp15_;
#line 40 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
#line 45 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp2_ = server;
#line 45 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
#line 46 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp4_ = message;
#line 46 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
#line 48 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	self->priv->chunks_buffered = (gint64) 0;
#line 49 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	self->priv->bytes_sent = (gint64) 0;
#line 50 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp6_ = G_MAXINT64;
#line 50 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	self->priv->max_bytes = _tmp6_;
#line 51 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp8_ = offsets;
#line 51 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	if (_tmp8_ != NULL) {
#line 202 "rygel-data-sink.c"
		RygelHTTPSeek* _tmp9_;
#line 52 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
		_tmp9_ = offsets;
#line 52 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
		_tmp7_ = RYGEL_IS_HTTP_BYTE_SEEK (_tmp9_);
...
#line 218 "rygel-data-sink.c"
		...
		gint64 _tmp12_;
		gint64 _tmp13_;
#line 53 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
		_tmp11_ = offsets;
#line 53 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
static void rygel_data_sink_on_wrote_chunk (RygelDataSink* self, SoupMessage* msg) {
	gint64 _tmp0_;
	gint64 _tmp1_;
#line 60 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	g_return_if_fail (self != NULL);
#line 60 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	g_return_if_fail (msg != NULL);
#line 61 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp0_ = self->priv->chunks_buffered;
#line 61 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	self->priv->chunks_buffered = _tmp0_ - 1;
#line 62 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
#line 63 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
static void rygel_data_sink_on_data_available (RygelDataSink* self, guint8* buffer, int buffer_length1) {
	...
	SoupMessage* _tmp14_;
	gint64 _tmp15_;
#line 67 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	g_return_if_fail (self != NULL);
#line 68 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp0_ = self->priv->max_bytes;
#line 68 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp1_ = self->priv->bytes_sent;
#line 68 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	left = _tmp0_ - _tmp1_;
#line 70 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp2_ = left;
#line 70 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	if (_tmp2_ <= ((gint64) 0)) {
#line 71 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
		return;
#line 314 "rygel-data-sink.c"
	}
#line 74 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp3_ = buffer;
#line 74 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
#line 74 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	to_send = _tmp5_;
#line 76 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
#line 76 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp9_ = to_send;
#line 76 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	soup_message_body_append (_tmp7_, SOUP_MEMORY_COPY, _tmp8_ + 0, (gsize) (_tmp9_ - 0));
#line 78 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp10_ = self->priv->chunks_buffered;
#line 78 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	self->priv->chunks_buffered = _tmp10_ + 1;
#line 79 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp11_ = self->priv->bytes_sent;
#line 79 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp12_ = to_send;
#line 79 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	self->priv->bytes_sent = _tmp11_ + _tmp12_;
#line 81 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp13_ = self->priv->server;
#line 81 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_tmp14_ = self->priv->message;
#line 81 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	soup_server_unpause_message (_tmp13_, _tmp14_);
#line 83 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
#line 84 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
#line 28 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
...
static void rygel_data_sink_finalize (GObject* obj) {
	RygelDataSink * self;
#line 28 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	self = RYGEL_DATA_SINK (obj);
#line 29 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_g_object_unref0 (self->priv->source);
#line 30 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_g_object_unref0 (self->priv->server);
#line 31 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
	_g_object_unref0 (self->priv->message);
#line 28 "/home/mryan/src/rygel/src/librygel-server/rygel-data-sink.vala"
