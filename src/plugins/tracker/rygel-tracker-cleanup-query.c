...
RygelTrackerCleanupQuery* rygel_tracker_cleanup_query_construct (GType object_type, const gchar* category) {
	...
	const gchar* _tmp3_;
	gchar* _tmp4_;
#line 32 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	g_return_val_if_fail (category != NULL, NULL);
#line 33 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_tmp0_ = rygel_tracker_query_triplets_new ();
#line 33 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	triplets = _tmp0_;
#line 34 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
...
#line 36 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	self = (RygelTrackerCleanupQuery*) rygel_tracker_query_construct (object_type, triplets);
#line 38 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_tmp3_ = category;
#line 38 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
...
static void rygel_tracker_cleanup_query_real_execute_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 29 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
...
#line 264 "rygel-tracker-cleanup-query.c"
}
...
#line 29 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
		return;
#line 274 "rygel-tracker-cleanup-query.c"
	}
#line 29 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_data_ = g_simple_async_result_get_op_res_gpointer (G_SIMPLE_ASYNC_RESULT (_res_));
#line 278 "rygel-tracker-cleanup-query.c"
}


static void rygel_tracker_cleanup_query_execute_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	RygelTrackerCleanupQueryExecuteData* _data_;
#line 49 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_data_ = _user_data_;
#line 49 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
...
#line 49 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	rygel_tracker_cleanup_query_real_execute_co (_data_);
#line 292 "rygel-tracker-cleanup-query.c"
}


static gboolean rygel_tracker_cleanup_query_real_execute_co (RygelTrackerCleanupQueryExecuteData* _data_) {
#line 41 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	switch (_data_->_state_) {
#line 41 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
		case 0:
#line 301 "rygel-tracker-cleanup-query.c"
		goto _state_0;
#line 41 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
		case 1:
#line 305 "rygel-tracker-cleanup-query.c"
		goto _state_1;
		default:
#line 41 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
		g_assert_not_reached ();
#line 310 "rygel-tracker-cleanup-query.c"
	}
	_state_0:
#line 45 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_data_->_tmp0_ = NULL;
#line 45 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_data_->_tmp0_ = rygel_tracker_query_to_string ((RygelTrackerQuery*) _data_->self);
#line 45 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_data_->str = _data_->_tmp0_;
#line 47 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
...
#line 347 "rygel-tracker-cleanup-query.c"
			} else {
#line 49 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
...
#line 49 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
			return FALSE;
#line 357 "rygel-tracker-cleanup-query.c"
		} else {
#line 49 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
			_g_free0 (_data_->str);
#line 49 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
...
#line 49 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
			return FALSE;
#line 367 "rygel-tracker-cleanup-query.c"
		}
	}
#line 41 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_g_free0 (_data_->str);
...
#line 41 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 376 "rygel-tracker-cleanup-query.c"
	} else {
#line 41 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
		g_simple_async_result_complete (_data_->_async_result);
...
#line 41 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	return FALSE;
#line 386 "rygel-tracker-cleanup-query.c"
}
...
static gchar* rygel_tracker_cleanup_query_real_to_string (RygelTrackerQuery* base) {
	...
	const gchar* _tmp4_;
	gchar* _tmp5_;
#line 52 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	self = (RygelTrackerCleanupQuery*) base;
#line 53 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_tmp0_ = g_string_new ("");
#line 53 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_result_ = _tmp0_;
#line 55 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	g_string_append (_result_, "DELETE {");
#line 56 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
...
#line 56 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_g_free0 (_tmp2_);
#line 57 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	g_string_append (_result_, "} WHERE {");
#line 58 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_tmp3_ = self->priv->category;
#line 58 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	g_string_append_printf (_result_, "?r a nie:DataObject, %s . ", _tmp3_);
#line 59 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	g_string_append (_result_, " ?r nie:generator \"rygel\". ");
#line 60 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	g_string_append (_result_, "FILTER(NOT EXISTS { ?r ");
#line 61 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	g_string_append (_result_, "a nfo:FileDataObject. })}");
#line 63 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_tmp4_ = _result_->str;
#line 63 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
...
#line 63 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	return result;
#line 438 "rygel-tracker-cleanup-query.c"
}
...
#line 455 "rygel-tracker-cleanup-query.c"
}
...
#line 30 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	_g_free0 (self->priv->category);
#line 29 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-cleanup-query.vala"
	RYGEL_TRACKER_QUERY_CLASS (rygel_tracker_cleanup_query_parent_class)->finalize (obj);
#line 474 "rygel-tracker-cleanup-query.c"
}
