/* rygel-tracker-search-container.c generated by valac 0.18.0, the Vala compiler
...
RygelTrackerSearchContainer* rygel_tracker_search_container_construct (GType object_type, const gchar* id, RygelMediaContainer* parent, const gchar* title, RygelTrackerItemFactory* item_factory, RygelTrackerQueryTriplets* triplets, GeeArrayList* filters) {
	...
	RygelTrackerQueryTriplets* _tmp47_;
	...
	property_map = _tmp27_;
	{
		...
		while (TRUE) {
			...
			RygelTrackerUPnPPropertyMap* _tmp41_;
			const gchar* _tmp42_;
			gchar* _tmp43_ = NULL;
			gchar* _tmp44_;
	...
	self->query = _tmp49_;
	{
		...
		TrackerSparqlConnection* _tmp51_;
		_tmp50_ = tracker_sparql_connection_get (NULL, &_inner_error_);
		_tmp51_ = _tmp50_;
		if (_inner_error_ != NULL) {
			goto __catch4_g_error;
		}
		_g_object_unref0 (self->priv->resources);
		self->priv->resources = _tmp51_;
...
static gboolean rygel_tracker_search_container_real_get_children_co (RygelTrackerSearchContainerGetChildrenData* _data_) {
	...
	_data_->_tmp9_ = 0U;
	_data_->_state_ = 1;
	rygel_tracker_search_container_execute_query (_data_->self, (RygelSearchExpression*) _data_->expression, _data_->_tmp5_, _data_->_tmp6_, _data_->_tmp7_, _data_->_tmp8_, rygel_tracker_search_container_get_children_ready, _data_);
	return FALSE;
	_state_1:
	_data_->_tmp10_ = NULL;
	_data_->_tmp10_ = rygel_tracker_search_container_execute_query_finish (_data_->self, _data_->_res_, &_data_->_tmp9_, &_data_->_inner_error_);
...
static RygelTrackerSelectionQuery* rygel_tracker_search_container_create_query (RygelTrackerSearchContainer* self, RygelRelationalExpression* expression, gint offset, gint max_count, const gchar* sort_criteria) {
	...
	RygelTrackerSelectionQuery* _tmp31_;
	gint _tmp32_;
	RygelTrackerSelectionQuery* _tmp33_;
	gint _tmp34_;
	g_return_val_if_fail (self != NULL, NULL);
	...
	if (g_strcmp0 ((const gchar*) _tmp18_, "@parentID") == 0) {
		...
		if (g_strcmp0 ((const gchar*) _tmp24_, "upnp:class") != 0) {
			...
			_tmp27_ = filter;
			if (_tmp27_ != NULL) {
				RygelTrackerSelectionQuery* _tmp28_;
				GeeArrayList* _tmp29_;
				const gchar* _tmp30_;
				_tmp28_ = query;
