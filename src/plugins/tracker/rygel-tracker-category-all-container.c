/* rygel-tracker-category-all-container.c generated by valac 0.18.0, the Vala compiler
...
RygelTrackerCategoryAllContainer* rygel_tracker_category_all_container_construct (GType object_type, RygelTrackerCategoryContainer* parent) {
	...
	_g_object_unref0 (_tmp15_);
	{
		...
		_tmp16_ = tracker_sparql_connection_get (NULL, &_inner_error_);
		_tmp17_ = _tmp16_;
		if (_inner_error_ != NULL) {
			goto __catch6_g_error;
		}
		_g_object_unref0 (self->priv->resources);
		self->priv->resources = _tmp17_;
	}
	goto __finally6;
	__catch6_g_error:
	{
