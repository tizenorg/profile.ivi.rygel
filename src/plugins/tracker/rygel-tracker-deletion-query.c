...
RygelTrackerDeletionQuery* rygel_tracker_deletion_query_construct (GType object_type, const gchar* id) {
	...
	const gchar* _tmp8_;
	gchar* _tmp9_;
#line 33 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	g_return_val_if_fail (id != NULL, NULL);
#line 34 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	_tmp0_ = rygel_tracker_query_triplets_new ();
#line 34 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	triplets = _tmp0_;
#line 35 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	_tmp1_ = id;
#line 35 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
...
#line 35 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	_g_free0 (_tmp3_);
#line 37 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	self = (RygelTrackerDeletionQuery*) rygel_tracker_query_construct (object_type, triplets);
#line 39 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	_tmp8_ = id;
#line 39 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
...
static void rygel_tracker_deletion_query_real_execute_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 30 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
...
#line 284 "rygel-tracker-deletion-query.c"
}
...
#line 30 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
		return;
#line 294 "rygel-tracker-deletion-query.c"
	}
#line 30 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	_data_ = g_simple_async_result_get_op_res_gpointer (G_SIMPLE_ASYNC_RESULT (_res_));
#line 298 "rygel-tracker-deletion-query.c"
}


static void rygel_tracker_deletion_query_execute_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	RygelTrackerDeletionQueryExecuteData* _data_;
#line 48 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	_data_ = _user_data_;
#line 48 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
...
#line 48 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	rygel_tracker_deletion_query_real_execute_co (_data_);
#line 312 "rygel-tracker-deletion-query.c"
}


static gboolean rygel_tracker_deletion_query_real_execute_co (RygelTrackerDeletionQueryExecuteData* _data_) {
#line 42 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	switch (_data_->_state_) {
#line 42 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
		case 0:
#line 321 "rygel-tracker-deletion-query.c"
		goto _state_0;
#line 42 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
		case 1:
#line 325 "rygel-tracker-deletion-query.c"
		goto _state_1;
		default:
#line 42 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
		g_assert_not_reached ();
#line 330 "rygel-tracker-deletion-query.c"
	}
	_state_0:
#line 44 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	_data_->_tmp0_ = NULL;
#line 44 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	_data_->_tmp0_ = rygel_tracker_query_to_string ((RygelTrackerQuery*) _data_->self);
#line 44 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	_data_->str = _data_->_tmp0_;
#line 46 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
...
#line 48 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	return FALSE;
#line 349 "rygel-tracker-deletion-query.c"
	_state_1:
#line 48 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
...
#line 367 "rygel-tracker-deletion-query.c"
			} else {
#line 48 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
...
#line 48 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
			return FALSE;
#line 377 "rygel-tracker-deletion-query.c"
		} else {
#line 48 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
			_g_free0 (_data_->str);
#line 48 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
...
#line 48 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
			return FALSE;
#line 387 "rygel-tracker-deletion-query.c"
		}
	}
#line 50 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
...
#line 42 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 400 "rygel-tracker-deletion-query.c"
	} else {
#line 42 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 404 "rygel-tracker-deletion-query.c"
	}
#line 42 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	g_object_unref (_data_->_async_result);
#line 42 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
...
static gchar* rygel_tracker_deletion_query_real_to_string (RygelTrackerQuery* base) {
	...
	gchar* _tmp4_;
	gchar* _tmp5_;
#line 53 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	self = (RygelTrackerDeletionQuery*) base;
#line 54 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
...
#line 54 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	return result;
#line 445 "rygel-tracker-deletion-query.c"
}
...
#line 462 "rygel-tracker-deletion-query.c"
}
...
#line 469 "rygel-tracker-deletion-query.c"
}
...
#line 31 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	_g_free0 (self->priv->id);
#line 30 "/home/mryan/src/rygel/src/plugins/tracker/rygel-tracker-deletion-query.vala"
	RYGEL_TRACKER_QUERY_CLASS (rygel_tracker_deletion_query_parent_class)->finalize (obj);
#line 481 "rygel-tracker-deletion-query.c"
}
