...
#line 26 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	g_return_if_fail (loader != NULL);
#line 27 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	_tmp0_ = loader;
#line 27 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	_tmp1_ = rygel_plugin_loader_plugin_disabled (_tmp0_, RYGEL_GST_LAUNCH_PLUGIN_NAME);
#line 27 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	if (_tmp1_) {
#line 28 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
		g_message ("rygel-gst-launch-plugin.vala:28: Plugin '%s' disabled by user, ignorin" \
"g..", RYGEL_GST_LAUNCH_PLUGIN_NAME);
#line 31 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
		return;
#line 101 "rygel-gst-launch-plugin.c"
	}
#line 34 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	_tmp2_ = rygel_gst_launch_plugin_new ();
#line 34 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	plugin = _tmp2_;
#line 36 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	_tmp3_ = loader;
#line 36 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	_tmp4_ = plugin;
#line 36 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
...
#line 115 "rygel-gst-launch-plugin.c"
}
...
#line 43 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	_tmp0_ = rygel_gst_launch_root_container_new ("Gst Launch");
#line 43 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	root_container = _tmp0_;
#line 45 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
...
#line 42 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	_g_object_unref0 (root_container);
#line 42 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	return self;
#line 133 "rygel-gst-launch-plugin.c"
}
...
#line 140 "rygel-gst-launch-plugin.c"
}


static void rygel_gst_launch_plugin_class_init (RygelGstLaunchPluginClass * klass) {
#line 39 "/home/mryan/src/rygel/src/plugins/gst-launch/rygel-gst-launch-plugin.vala"
	rygel_gst_launch_plugin_parent_class = g_type_class_peek_parent (klass);
#line 147 "rygel-gst-launch-plugin.c"
}
