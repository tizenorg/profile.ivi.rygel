/* rygel-media-export-db-container.c generated by valac 0.18.0, the Vala compiler
...
static void rygel_media_export_db_container_real_constructed (GObject* base) {
	...
	_tmp3_ = rygel_media_export_db_container_count_children (self);
	rygel_media_container_set_child_count ((RygelMediaContainer*) self, _tmp3_);
}
...
static gint rygel_media_export_db_container_real_count_children (RygelMediaExportDBContainer* self) {
	...
	__catch3_rygel_media_export_database_error:
	{
		...
		g_debug ("rygel-media-export-db-container.vala:52: Could not get child count fro" \
"m database: %s", _tmp6_);
		result = 0;
