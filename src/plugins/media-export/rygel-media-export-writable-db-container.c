/* rygel-media-export-writable-db-container.c generated by valac 0.18.0, the Vala compiler
...
static void rygel_media_export_writable_db_container_real_constructed (GObject* base) {
	...
	_tmp15_ = _tmp14_;
	gee_abstract_collection_add ((GeeAbstractCollection*) _tmp15_, RYGEL_MEDIA_CONTAINER_STORAGE_FOLDER);
}
...
static gboolean rygel_media_export_writable_db_container_real_add_container_co (RygelMediaExportWritableDbContainerAddContainerData* _data_) {
	...
	if (_data_->_tmp6_ == g_quark_from_string (RYGEL_MEDIA_CONTAINER_STORAGE_FOLDER)) {
		switch (0) {
			default:
			{
