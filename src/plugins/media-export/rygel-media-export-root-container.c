/* rygel-media-export-root-container.c generated by valac 0.18.0, the Vala compiler
...
static gboolean rygel_media_export_root_container_real_find_object_co (RygelMediaExportRootContainerFindObjectData* _data_) {
	...
	if (_data_->_tmp5_) {
		...
		if (_data_->_tmp13_) {
			...
			_data_->_state_ = 2;
			RYGEL_MEDIA_CONTAINER_CLASS (rygel_media_export_root_container_parent_class)->find_object ((RygelMediaContainer*) G_TYPE_CHECK_INSTANCE_CAST (_data_->self, RYGEL_MEDIA_EXPORT_TYPE_TRACKABLE_DB_CONTAINER, RygelMediaExportTrackableDbContainer), _data_->_tmp21_, _data_->_tmp22_, rygel_media_export_root_container_find_object_ready, _data_);
			return FALSE;
			_state_2:
			_data_->_tmp23_ = NULL;
			_data_->_tmp23_ = RYGEL_MEDIA_CONTAINER_CLASS (rygel_media_export_root_container_parent_class)->find_object_finish ((RygelMediaContainer*) G_TYPE_CHECK_INSTANCE_CAST (_data_->self, RYGEL_MEDIA_EXPORT_TYPE_TRACKABLE_DB_CONTAINER, RygelMediaExportTrackableDbContainer), _data_->_res_, &_data_->_inner_error_);
...
static gboolean rygel_media_export_root_container_real_search_co (RygelMediaExportRootContainerSearchData* _data_) {
	...
	if (_data_->_tmp0_ == NULL) {
		...
		_data_->_tmp6_ = 0U;
		_data_->_state_ = 1;
		RYGEL_MEDIA_EXPORT_DB_CONTAINER_CLASS (rygel_media_export_root_container_parent_class)->search ((RygelMediaExportDBContainer*) G_TYPE_CHECK_INSTANCE_CAST (_data_->self, RYGEL_MEDIA_EXPORT_TYPE_TRACKABLE_DB_CONTAINER, RygelMediaExportTrackableDbContainer), _data_->_tmp1_, _data_->_tmp2_, _data_->_tmp3_, _data_->_tmp4_, _data_->_tmp5_, rygel_media_export_root_container_search_ready, _data_);
		return FALSE;
		_state_1:
		_data_->_tmp7_ = NULL;
		_data_->_tmp7_ = RYGEL_MEDIA_EXPORT_DB_CONTAINER_CLASS (rygel_media_export_root_container_parent_class)->search_finish ((RygelMediaExportDBContainer*) G_TYPE_CHECK_INSTANCE_CAST (_data_->self, RYGEL_MEDIA_EXPORT_TYPE_TRACKABLE_DB_CONTAINER, RygelMediaExportTrackableDbContainer), _data_->_res_, &_data_->_tmp6_, &_data_->_inner_error_);
	...
	if (_data_->_tmp20_ != NULL) {
		...
		_data_->_tmp50_ = 0U;
		_data_->_state_ = 3;
		RYGEL_MEDIA_EXPORT_DB_CONTAINER_CLASS (rygel_media_export_root_container_parent_class)->search ((RygelMediaExportDBContainer*) G_TYPE_CHECK_INSTANCE_CAST (_data_->self, RYGEL_MEDIA_EXPORT_TYPE_TRACKABLE_DB_CONTAINER, RygelMediaExportTrackableDbContainer), _data_->_tmp45_, _data_->_tmp46_, _data_->_tmp47_, _data_->_tmp48_, _data_->_tmp49_, rygel_media_export_root_container_search_ready, _data_);
		return FALSE;
		_state_3:
		_data_->_tmp51_ = NULL;
		_data_->_tmp51_ = RYGEL_MEDIA_EXPORT_DB_CONTAINER_CLASS (rygel_media_export_root_container_parent_class)->search_finish ((RygelMediaExportDBContainer*) G_TYPE_CHECK_INSTANCE_CAST (_data_->self, RYGEL_MEDIA_EXPORT_TYPE_TRACKABLE_DB_CONTAINER, RygelMediaExportTrackableDbContainer), _data_->_res_, &_data_->_tmp50_, &_data_->_inner_error_);
...
static void rygel_media_export_root_container_init (RygelMediaExportRootContainer* self, GError** error) {
	...
	}
	{
		...
		RygelMediaExportTrackableDbContainer* _tmp4_;
		RygelMediaExportDBContainer* _tmp5_;
		RygelMediaExportMediaCache* _tmp6_;
		RygelMediaExportDBContainer* _tmp7_;
	...
	}
	{
		...
		_tmp9_ = rygel_media_export_media_cache_get_child_ids (_tmp8_, RYGEL_MEDIA_EXPORT_ROOT_CONTAINER_FILESYSTEM_FOLDER_ID, &_inner_error_);
		_tmp10_ = _tmp9_;
		if (_inner_error_ != NULL) {
...
static void rygel_media_export_root_container_handle_uri_config_change (RygelMediaExportRootContainer* self) {
	...
	gee_collection_remove_all ((GeeCollection*) _tmp13_, (GeeCollection*) _tmp14_);
	{
		...
		while (TRUE) {
			...
			GFile* file;
			RygelMediaExportHarvester* _tmp26_;
			GFile* _tmp27_;
			_tmp20_ = _file_index;
			...
			{
				RygelMediaExportMediaCache* _tmp28_;
				GFile* _tmp29_;
				gchar* _tmp30_ = NULL;
				gchar* _tmp31_;
	...
	_tmp41_ = _tmp40_;
	if (!_tmp41_) {
		RygelMediaExportDBContainer* _tmp42_;
		gulong _tmp43_;
	...
	}
	{
		...
		while (TRUE) {
			...
			if (_tmp58_) {
				RygelMediaExportHarvester* _tmp59_;
				GeeArrayList* _tmp60_;
				GeeArrayList* _tmp61_;
				GFile* _tmp62_;
				RygelMediaExportHarvester* _tmp63_;
				GFile* _tmp64_;
				RygelMediaExportDBContainer* _tmp65_;
		...
		_tmp12__length1 = definitions_length1;
		{
			...
			for (definition_it = 0; definition_it < _tmp12__length1; definition_it = definition_it + 1) {
				...
				definition = _tmp13_;
				{
					...
					const gchar* _tmp15_;
					RygelMediaExportFolderDefinition _tmp16_;
					_tmp14_ = container;
					_tmp15_ = item_class;
					_tmp16_ = definition;
