...
static void __lambda4_ (RygelMediaExportJPEGWriter* self) {
	GMainLoop* _tmp0_;
#line 45 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
...
static void __lambda5_ (RygelMediaExportJPEGWriter* self) {
	GMainLoop* _tmp0_;
#line 46 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_tmp0_ = self->priv->loop;
#line 46 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	g_main_loop_quit (_tmp0_);
...
#line 37 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	self = (RygelMediaExportJPEGWriter*) g_object_new (object_type, NULL);
#line 38 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
...
#line 38 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
		return NULL;
#line 147 "rygel-media-export-jpeg-writer.c"
	}
#line 38 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_gst_object_unref0 (self->priv->bin);
#line 38 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	self->priv->bin = GST_IS_BIN (_tmp1_) ? ((GstBin*) _tmp1_) : NULL;
#line 41 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
...
#line 42 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
...
#line 43 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_tmp6_ = self->priv->bin;
#line 43 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_tmp7_ = gst_element_get_bus ((GstElement*) _tmp6_);
#line 43 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	bus = _tmp7_;
#line 44 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_tmp8_ = bus;
#line 44 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
...
#line 47 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
...
#line 37 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	return self;
#line 197 "rygel-media-export-jpeg-writer.c"
}
...
#line 204 "rygel-media-export-jpeg-writer.c"
}
...
/**
     ...
     */
static inline void _dynamic_set_file0 (GstElement* obj, GFile* value) {
#line 59 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	g_object_set (obj, "file", value, NULL);
#line 219 "rygel-media-export-jpeg-writer.c"
}


static gpointer _gst_buffer_ref0 (gpointer self) {
#line 60 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	return self ? gst_buffer_ref (self) : NULL;
#line 226 "rygel-media-export-jpeg-writer.c"
}
...
void rygel_media_export_jpeg_writer_write (RygelMediaExportJPEGWriter* self, GstBuffer* buffer, GFile* file) {
	...
	GMainLoop* _tmp7_;
	GstBin* _tmp8_;
#line 58 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
...
#line 61 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_tmp5_ = self->priv->appsrc;
#line 61 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	gst_app_src_end_of_stream (_tmp5_);
#line 62 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_tmp6_ = self->priv->bin;
#line 62 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	gst_element_set_state ((GstElement*) _tmp6_, GST_STATE_PLAYING);
#line 63 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_tmp7_ = self->priv->loop;
#line 63 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	g_main_loop_run (_tmp7_);
#line 64 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_tmp8_ = self->priv->bin;
#line 64 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	gst_element_set_state ((GstElement*) _tmp8_, GST_STATE_NULL);
#line 276 "rygel-media-export-jpeg-writer.c"
}


static void rygel_media_export_jpeg_writer_class_init (RygelMediaExportJPEGWriterClass * klass) {
#line 31 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
...
#line 287 "rygel-media-export-jpeg-writer.c"
}
...
#line 294 "rygel-media-export-jpeg-writer.c"
}
...
#line 32 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_gst_object_unref0 (self->priv->bin);
#line 33 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_gst_object_unref0 (self->priv->appsrc);
#line 34 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_g_main_loop_unref0 (self->priv->loop);
#line 35 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	_gst_object_unref0 (self->priv->sink);
#line 31 "/home/mryan/src/rygel/src/plugins/media-export/rygel-media-export-jpeg-writer.vala"
	G_OBJECT_CLASS (rygel_media_export_jpeg_writer_parent_class)->finalize (obj);
#line 312 "rygel-media-export-jpeg-writer.c"
}
