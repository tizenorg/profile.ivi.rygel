/* rygel-media-export-query-container-factory.c generated by valac 0.18.0, the Vala compiler
...
RygelMediaExportQueryContainer* rygel_media_export_query_container_factory_create_from_description_id (RygelMediaExportQueryContainerFactory* self, const gchar* definition_id, const gchar* name) {
	...
	if (_tmp12_) {
		...
		const gchar* _tmp14_;
		const gchar* _tmp15_;
		RygelMediaExportLeafQueryContainer* _tmp16_;
		_tmp13_ = expression;
		_tmp14_ = id;
		_tmp15_ = title;
		...
		const gchar* _tmp20_;
		const gchar* _tmp21_;
		RygelMediaExportNodeQueryContainer* _tmp22_;
		_tmp17_ = expression;
		_tmp18_ = id;
		_tmp19_ = title;
		_tmp20_ = pattern;
