/* rygel-media-export-leaf-query-container.c generated by valac 0.18.0, the Vala compiler
...
static gint rygel_media_export_leaf_query_container_real_count_children (RygelMediaExportDBContainer* base) {
	...
	self = (RygelMediaExportLeafQueryContainer*) base;
	{
		...
		_tmp1_ = rygel_media_export_query_container_get_expression ((RygelMediaExportQueryContainer*) self);
		_tmp2_ = _tmp1_;
		_tmp3_ = rygel_media_export_media_cache_get_object_count_by_search_expression (_tmp0_, _tmp2_, NULL, &_inner_error_);
		_tmp4_ = _tmp3_;
		if (_inner_error_ != NULL) {
