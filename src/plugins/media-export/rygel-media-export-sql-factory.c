...
#define RYGEL_MEDIA_EXPORT_SQL_FACTORY_INSERT_OBJECT_STRING "INSERT OR REPLACE INTO Object " "(upnp_id, title, type_fk, parent, timestamp, uri, " "object_update_id, deleted_child_count, container_update_id, " "is_guarded) VALUES " "(?,?,?,?,?,?,?,?,?,?)"
#define RYGEL_MEDIA_EXPORT_SQL_FACTORY_UPDATE_GUARDED_OBJECT_STRING "REPLACE INTO Object " "(upnp_id, type_fk, parent, timestamp, uri, " "object_update_id, deleted_child_count, container_update_id) " "VALUES (?,?,?,?,?,?,?,?)"
