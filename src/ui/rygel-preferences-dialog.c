/* rygel-preferences-dialog.c generated by valac 0.18.0, the Vala compiler
...
RygelPreferencesDialog* rygel_preferences_dialog_construct (GType object_type, GError** error) {
	...
	_tmp6_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp5_, GTK_TYPE_WIDGET) ? ((GtkWidget*) _tmp5_) : NULL);
	toolbar = _tmp6_;
	_tmp7_ = toolbar;
	...
	_tmp14_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp13_, GTK_TYPE_DIALOG, GtkDialog));
	...
	_vala_assert (_tmp19_ != NULL, "this.upnp_check != null");
