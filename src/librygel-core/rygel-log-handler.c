...
#line 53 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	return self ? g_object_ref (self) : NULL;
#line 161 "rygel-log-handler.c"
}
...
#line 49 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	_tmp0_ = rygel_log_handler_log_handler;
#line 49 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	if (_tmp0_ == NULL) {
#line 174 "rygel-log-handler.c"
		RygelLogHandler* _tmp1_;
#line 50 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		_tmp1_ = rygel_log_handler_new ();
#line 50 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		_g_object_unref0 (rygel_log_handler_log_handler);
#line 50 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		rygel_log_handler_log_handler = _tmp1_;
#line 182 "rygel-log-handler.c"
	}
#line 53 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
static void _rygel_log_handler_log_func_glog_func (const gchar* log_domain, GLogLevelFlags log_levels, const gchar* message, gpointer self) {
#line 94 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	rygel_log_handler_log_func (self, log_domain, log_levels, message);
#line 199 "rygel-log-handler.c"
}
...
#line 56 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	self = (RygelLogHandler*) g_object_new (object_type, NULL);
#line 57 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 60 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	_tmp1_ = rygel_meta_config_get_default ();
#line 60 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	config = _tmp1_;
#line 225 "rygel-log-handler.c"
	{
		RygelMetaConfig* _tmp2_;
		gchar* _tmp3_ = NULL;
		gchar* _tmp4_;
#line 64 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		_tmp2_ = config;
#line 64 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 245 "rygel-log-handler.c"
	...
	__catch5_g_error:
	{
		...
		GError* _tmp7_;
		const gchar* _tmp8_;
#line 63 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		err = _inner_error_;
#line 63 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		_inner_error_ = NULL;
#line 66 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		_tmp5_ = g_strdup (RYGEL_LOG_HANDLER_DEFAULT_LEVELS);
#line 66 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		_g_free0 (log_levels);
#line 66 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		log_levels = _tmp5_;
#line 68 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 63 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		return NULL;
#line 290 "rygel-log-handler.c"
	}
#line 72 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	_tmp9_ = log_levels;
#line 72 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	_tmp11_ = _tmp10_ = g_strsplit (_tmp9_, ",", 0);
#line 296 "rygel-log-handler.c"
	{
...
#line 73 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
				_tmp13_ = pair;
#line 73 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 74 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
				_tmp16_ = tokens;
#line 74 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
				_tmp16__length1 = tokens_length1;
#line 74 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
				if (_tmp16__length1 < 1) {
#line 75 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
					tokens = (_vala_array_free (tokens, tokens_length1, (GDestroyNotify) g_free), NULL);
#line 75 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
					_g_free0 (pair);
#line 75 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
					break;
#line 357 "rygel-log-handler.c"
				}
#line 81 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
				_tmp17_ = tokens;
#line 81 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 365 "rygel-log-handler.c"
					...
					gint _tmp20_ = 0;
					gchar* _tmp21_;
#line 82 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
					_tmp18_ = tokens;
#line 82 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 83 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
					_tmp21_ = g_strdup ("*");
#line 83 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
					_g_free0 (domain);
#line 83 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
					domain = _tmp21_;
#line 387 "rygel-log-handler.c"
				} else {
					gchar** _tmp22_;
					...
					const gchar* _tmp26_;
					gint _tmp27_ = 0;
#line 85 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
					_tmp22_ = tokens;
#line 85 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 85 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
					domain = _tmp24_;
#line 86 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
					_tmp25_ = tokens;
#line 86 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 419 "rygel-log-handler.c"
				}
#line 89 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
				_tmp28_ = level;
#line 89 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
				_tmp29_ = rygel_log_handler_log_level_to_flags (self, _tmp28_);
#line 89 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
				flags = _tmp29_;
#line 91 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 97 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	g_return_if_fail (self != NULL);
#line 97 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	g_return_if_fail (message != NULL);
#line 100 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	flags = 0;
#line 102 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	_tmp0_ = log_domain;
#line 102 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	if (_tmp0_ != NULL) {
#line 483 "rygel-log-handler.c"
		GeeHashMap* _tmp1_;
		const gchar* _tmp2_;
		gpointer _tmp3_ = NULL;
#line 103 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 495 "rygel-log-handler.c"
	}
#line 106 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	_tmp4_ = flags;
#line 106 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	if (_tmp4_ == 0) {
#line 501 "rygel-log-handler.c"
		GeeHashMap* _tmp5_;
		gpointer _tmp6_ = NULL;
#line 107 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		_tmp5_ = self->priv->log_level_hash;
#line 107 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		_tmp6_ = gee_abstract_map_get ((GeeAbstractMap*) _tmp5_, "*");
#line 107 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		flags = GPOINTER_TO_INT (_tmp6_);
#line 510 "rygel-log-handler.c"
	}
#line 110 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	_tmp7_ = log_levels;
#line 110 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	_tmp8_ = flags;
#line 110 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 518 "rygel-log-handler.c"
		...
		const gchar* _tmp12_;
#line 112 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 116 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	g_return_val_if_fail (self != NULL, 0);
#line 117 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	flags = RYGEL_LOG_HANDLER_DEFAULT_FLAGS;
#line 119 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	_tmp0_ = level;
#line 119 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	switch (_tmp0_) {
#line 119 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		case RYGEL_LOG_LEVEL_CRITICAL:
#line 555 "rygel-log-handler.c"
		{
#line 121 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
			flags = G_LOG_LEVEL_CRITICAL;
#line 122 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
			break;
#line 561 "rygel-log-handler.c"
		}
#line 119 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		case RYGEL_LOG_LEVEL_ERROR:
#line 565 "rygel-log-handler.c"
		{
#line 124 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
			flags = G_LOG_LEVEL_CRITICAL | G_LOG_LEVEL_ERROR;
#line 126 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
			break;
#line 571 "rygel-log-handler.c"
		}
#line 119 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		case RYGEL_LOG_LEVEL_WARNING:
#line 575 "rygel-log-handler.c"
		{
#line 128 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
			flags = (G_LOG_LEVEL_WARNING | G_LOG_LEVEL_CRITICAL) | G_LOG_LEVEL_ERROR;
#line 131 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
			break;
#line 581 "rygel-log-handler.c"
		}
#line 119 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		case RYGEL_LOG_LEVEL_INFO:
#line 585 "rygel-log-handler.c"
		{
#line 133 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
			flags = (((G_LOG_LEVEL_WARNING | G_LOG_LEVEL_CRITICAL) | G_LOG_LEVEL_ERROR) | G_LOG_LEVEL_MESSAGE) | G_LOG_LEVEL_INFO;
#line 138 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
			break;
#line 591 "rygel-log-handler.c"
		}
#line 119 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
		case RYGEL_LOG_LEVEL_DEBUG:
#line 595 "rygel-log-handler.c"
		{
#line 140 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
			flags = ((((G_LOG_LEVEL_WARNING | G_LOG_LEVEL_CRITICAL) | G_LOG_LEVEL_ERROR) | G_LOG_LEVEL_MESSAGE) | G_LOG_LEVEL_INFO) | G_LOG_LEVEL_DEBUG;
#line 146 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
			break;
#line 601 "rygel-log-handler.c"
		}
		default:
		{
#line 148 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
			flags = RYGEL_LOG_HANDLER_DEFAULT_FLAGS;
#line 149 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
			break;
#line 609 "rygel-log-handler.c"
		}
	}
#line 152 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	result = flags;
#line 152 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	return result;
#line 616 "rygel-log-handler.c"
}


static void rygel_log_handler_class_init (RygelLogHandlerClass * klass) {
#line 36 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
...
#line 44 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	_g_object_unref0 (self->priv->log_level_hash);
#line 36 "/home/mryan/src/rygel/src/librygel-core/rygel-log-handler.vala"
	G_OBJECT_CLASS (rygel_log_handler_parent_class)->finalize (obj);
#line 646 "rygel-log-handler.c"
}
