/* rygel-meta-config.c generated by valac 0.18.0, the Vala compiler
	...
	unavailable = TRUE;
	{
		...
		while (TRUE) {
			...
			config = (RygelConfiguration*) _tmp10_;
			{
				...
				gint __tmp14__size_;
				_tmp11_ = config;
				_tmp13_ = _tmp12_ = rygel_configuration_get_interfaces (_tmp11_, &_inner_error_);
				_tmp14_ = _tmp13_;
