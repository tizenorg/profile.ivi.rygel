/* rygel-gst-media-engine.c generated by valac 0.18.0, the Vala compiler
...
RygelGstMediaEngine* rygel_gst_media_engine_construct (GType object_type) {
	...
	GUPnPDLNAProfileGuesser* discoverer;
	...
	config = _tmp15_;
	{
		...
		_tmp16_ = config;
		_tmp17_ = rygel_configuration_get_transcoding ((RygelConfiguration*) _tmp16_, &_inner_error_);
		_tmp18_ = _tmp17_;
		...
		transcoding = _tmp18_;
		_tmp19_ = config;
		_tmp20_ = rygel_configuration_get_string_list ((RygelConfiguration*) _tmp19_, "GstMediaEngine", "transcoders", &_inner_error_);
		_tmp21_ = _tmp20_;
		if (_inner_error_ != NULL) {
			goto __catch0_g_error;
		}
