/* rygel-video-transcoder.c generated by valac 0.18.0, the Vala compiler
...
static GstEncodingProfile* rygel_video_transcoder_real_get_encoding_profile (RygelGstTranscoder* base) {
	...
	enc_container_profile = G_TYPE_CHECK_INSTANCE_TYPE (_tmp0_, gst_encoding_container_profile_get_type ()) ? ((GstEncodingContainerProfile*) _tmp0_) : NULL;
	...
	_tmp6_ = _g_object_ref0 ((GstEncodingProfile*) enc_video_profile);
