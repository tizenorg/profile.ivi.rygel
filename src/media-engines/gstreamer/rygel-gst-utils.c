/* rygel-gst-utils.c generated by valac 0.18.0, the Vala compiler
...
GstElement* rygel_gst_utils_create_source_for_uri (const gchar* uri) {
	...
	g_return_val_if_fail (uri != NULL, NULL);
	{
		...
		if (_tmp1_) {
			...
			description = _tmp3_;
			_tmp4_ = description;
			_tmp5_ = gst_parse_bin_from_description_full (_tmp4_, TRUE, NULL, GST_PARSE_FLAG_NONE, &_inner_error_);
			_tmp6_ = _tmp5_;
			if (_inner_error_ != NULL) {
			...
			GstElement* _tmp9_;
			_tmp7_ = uri;
			_tmp8_ = gst_element_make_from_uri (GST_URI_SRC, _tmp7_, NULL, &_inner_error_);
			_tmp9_ = _tmp8_;
			if (_inner_error_ != NULL) {
				_g_object_unref0 (src);
				goto __catch2_g_error;
		...
		_tmp12_ = g_object_class_find_property (_tmp11_, "blocksize");
		if (_tmp12_ != NULL) {
			GstElement* _tmp13_;
			_tmp13_ = src;
			_dynamic_set_blocksize5 (_tmp13_, (glong) 65536);
		}
		_tmp14_ = src;
		_tmp15_ = G_OBJECT_GET_CLASS ((GObject*) _tmp14_);
		_tmp16_ = g_object_class_find_property (_tmp15_, "tcp-timeout");
		if (_tmp16_ != NULL) {
			GstElement* _tmp17_;
			_tmp17_ = src;
			_dynamic_set_tcp_timeout6 (_tmp17_, (gint64) 60000000);
		}
		result = src;
		return result;
	}
...
void rygel_gst_utils_dump_encoding_profile (GstEncodingProfile* profile, gint indent) {
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp27_, gst_encoding_container_profile_get_type ())) {
		...
		GstEncodingContainerProfile* _tmp29_;
		GstEncodingContainerProfile* container;
		GstEncodingContainerProfile* _tmp30_;
		GList* _tmp31_ = NULL;
		_tmp28_ = profile;
...
GstElement* rygel_gst_utils_get_rtp_depayloader (GstCaps* caps) {
	...
	_tmp6_ = features;
	_tmp7_ = _tmp6_->data;
	_tmp8_ = gst_object_get_name ((GstObject*) ((GstElementFactory*) _tmp7_));
	_tmp9_ = _tmp8_;
	_tmp10_ = g_strcmp0 (_tmp9_, "rtpdepay") == 0;
	_g_free0 (_tmp9_);
	if (_tmp10_) {
		GList* _tmp11_;
		GList* _tmp12_;
		...
		if (_tmp12_ != NULL) {
			...
			_tmp16_ = gst_element_factory_create ((GstElementFactory*) _tmp15_, NULL);
