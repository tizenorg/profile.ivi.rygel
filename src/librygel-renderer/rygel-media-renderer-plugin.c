...
#line 45 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	g_return_val_if_fail (name != NULL, NULL);
#line 50 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	_tmp0_ = name;
#line 50 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	_tmp1_ = title;
#line 50 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
...
#line 50 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	_tmp3_ = capabilities;
#line 50 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	self = (RygelMediaRendererPlugin*) rygel_plugin_construct (object_type, RYGEL_MEDIA_RENDERER_PLUGIN_MEDIA_RENDERER_DESC_PATH, _tmp0_, _tmp1_, _tmp2_, _tmp3_);
#line 52 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	_tmp4_ = rygel_resource_info_new (RYGEL_CONNECTION_MANAGER_UPNP_ID, RYGEL_CONNECTION_MANAGER_UPNP_TYPE, RYGEL_CONNECTION_MANAGER_DESCRIPTION_PATH, RYGEL_TYPE_SINK_CONNECTION_MANAGER);
#line 52 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	resource = _tmp4_;
#line 56 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	_tmp5_ = resource;
#line 56 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	rygel_plugin_add_resource ((RygelPlugin*) self, _tmp5_);
#line 58 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	_tmp6_ = rygel_resource_info_new (RYGEL_AV_TRANSPORT_UPNP_ID, RYGEL_AV_TRANSPORT_UPNP_TYPE, RYGEL_AV_TRANSPORT_DESCRIPTION_PATH, RYGEL_TYPE_AV_TRANSPORT);
#line 58 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	_rygel_resource_info_unref0 (resource);
#line 58 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	resource = _tmp6_;
#line 62 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	_tmp7_ = resource;
#line 62 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	rygel_plugin_add_resource ((RygelPlugin*) self, _tmp7_);
#line 64 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	_tmp8_ = rygel_resource_info_new (RYGEL_RENDERING_CONTROL_UPNP_ID, RYGEL_RENDERING_CONTROL_UPNP_TYPE, RYGEL_RENDERING_CONTROL_DESCRIPTION_PATH, RYGEL_TYPE_RENDERING_CONTROL);
#line 64 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	_rygel_resource_info_unref0 (resource);
#line 64 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	resource = _tmp8_;
#line 68 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	_tmp9_ = resource;
#line 68 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
...
#line 45 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	return self;
#line 209 "rygel-media-renderer-plugin.c"
}
...
#line 72 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	result = NULL;
#line 72 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	return result;
#line 226 "rygel-media-renderer-plugin.c"
}


RygelMediaPlayer* rygel_media_renderer_plugin_get_player (RygelMediaRendererPlugin* self) {
#line 71 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 71 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
	return RYGEL_MEDIA_RENDERER_PLUGIN_GET_CLASS (self)->get_player (self);
#line 235 "rygel-media-renderer-plugin.c"
}


static void rygel_media_renderer_plugin_class_init (RygelMediaRendererPluginClass * klass) {
#line 33 "/home/mryan/src/rygel/src/librygel-renderer/rygel-media-renderer-plugin.vala"
