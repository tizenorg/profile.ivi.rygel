...
RygelChangeLog* rygel_change_log_construct (GType object_type, GUPnPService* service, const gchar* service_ns) {
	...
	GString* _tmp3_;
	GeeHashMap* _tmp4_;
#line 39 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_return_val_if_fail (service_ns != NULL, NULL);
#line 39 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	self = (RygelChangeLog*) g_object_new (object_type, NULL);
#line 40 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_tmp0_ = service;
#line 40 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	rygel_change_log_set_service (self, _tmp0_);
#line 41 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_tmp1_ = service_ns;
#line 41 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
#line 42 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_tmp3_ = g_string_new ("");
#line 42 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_g_string_free0 (self->priv->str);
#line 42 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	self->priv->str = _tmp3_;
#line 43 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
static gboolean rygel_change_log_timeout (RygelChangeLog* self) {
	...
	GeeHashMap* _tmp3_;
	GString* _tmp4_;
#line 52 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 54 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
#line 54 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_g_free0 (_tmp2_);
#line 55 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_debug ("rygel-changelog.vala:55: LastChange sent");
#line 58 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_tmp3_ = self->priv->hash;
#line 58 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	gee_abstract_map_clear ((GeeAbstractMap*) _tmp3_);
#line 59 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_tmp4_ = self->priv->str;
#line 59 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_string_erase (_tmp4_, (gssize) 0, (gssize) (-1));
#line 60 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	self->priv->timeout_id = (guint) 0;
#line 62 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	result = FALSE;
#line 62 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	return result;
...
#line 69 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	return result;
...
static void rygel_change_log_ensure_timeout (RygelChangeLog* self) {
	...
	GUPnPService* _tmp1_;
	gboolean _tmp3_;
#line 65 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_return_if_fail (self != NULL);
#line 67 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
#line 213 "rygel-changelog.c"
		guint _tmp4_ = 0U;
#line 68 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
void rygel_change_log_log (RygelChangeLog* self, const gchar* variable, const gchar* value) {
	...
	gchar* _tmp6_ = NULL;
	gchar* _tmp7_;
#line 73 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_return_if_fail (self != NULL);
#line 73 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_return_if_fail (variable != NULL);
#line 73 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_return_if_fail (value != NULL);
#line 74 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_tmp0_ = variable;
#line 74 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_tmp1_ = value;
#line 74 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_debug ("rygel-changelog.vala:74: '%s = %s' logged", _tmp0_, _tmp1_);
#line 75 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
#line 75 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_g_free0 (_tmp7_);
#line 77 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
void rygel_change_log_log_with_channel (RygelChangeLog* self, const gchar* variable, const gchar* value, const gchar* channel) {
	...
	gchar* _tmp5_ = NULL;
	gchar* _tmp6_;
#line 80 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_return_if_fail (self != NULL);
#line 80 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_return_if_fail (variable != NULL);
#line 80 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
#line 83 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
#line 83 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_g_free0 (_tmp6_);
#line 88 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	rygel_change_log_ensure_timeout (self);
...
gchar* rygel_change_log_finish (RygelChangeLog* self) {
	...
	const gchar* _tmp20_;
	gchar* _tmp21_;
#line 91 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 92 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
#line 95 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
#line 95 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
			line = (gchar*) _tmp15_;
#line 96 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
#line 98 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_tmp18_ = self->priv->str;
#line 98 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_string_append (_tmp18_, "</InstanceID></Event>");
#line 100 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
GUPnPService* rygel_change_log_get_service (RygelChangeLog* self) {
	GUPnPService* result;
	GUPnPService* _tmp0_;
#line 29 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 29 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_tmp0_ = self->priv->_service;
#line 29 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
#line 28 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
...
#line 37 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	self->priv->timeout_id = (guint) 0;
...
#line 47 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_tmp0_ = self->priv->timeout_id;
#line 47 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	if (_tmp0_ != ((guint) 0)) {
#line 488 "rygel-changelog.c"
		guint _tmp1_;
#line 48 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
		_tmp1_ = self->priv->timeout_id;
#line 48 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
		g_source_remove (_tmp1_);
#line 494 "rygel-changelog.c"
	}
#line 31 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_g_free0 (self->priv->service_ns);
#line 33 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_g_string_free0 (self->priv->str);
#line 35 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
	_g_object_unref0 (self->priv->hash);
#line 28 "/home/mryan/src/rygel/src/librygel-renderer/rygel-changelog.vala"
